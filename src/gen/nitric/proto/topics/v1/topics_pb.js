 ...
 * @return {?proto.nitric.proto.topics.v1.Message}
 */
proto.nitric.proto.topics.v1.MessageRequest.prototype.getMessage = function() {
  return /** @type{?proto.nitric.proto.topics.v1.Message} */ (
    jspb.Message.getWrapperField(this, proto.nitric.proto.topics.v1.Message, 2));
};


/**
 * @param {?proto.nitric.proto.topics.v1.Message|undefined} value
 * @return {!proto.nitric.proto.topics.v1.MessageRequest} returns this
*/
...
/**
 * @return {proto.nitric.proto.topics.v1.Message.ContentCase}
 */
proto.nitric.proto.topics.v1.Message.prototype.getContentCase = function() {
  return /** @type {proto.nitric.proto.topics.v1.Message.ContentCase} */(jspb.Message.computeOneofCase(this, proto.nitric.proto.topics.v1.Message.oneofGroups_[0]));
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.nitric.proto.topics.v1.Message} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.nitric.proto.topics.v1.Message} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.nitric.proto.topics.v1.Message}
 */
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.nitric.proto.topics.v1.Message} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
 ...
 * @return {!proto.nitric.proto.topics.v1.Message} returns this
*/
