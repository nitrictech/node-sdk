[@nitric/sdk](../README.md) / [grpc](../modules/grpc.md) / [storage](../modules/grpc.storage.md) / StorageWriteResponse

# Class: StorageWriteResponse

[grpc](../modules/grpc.md).[storage](../modules/grpc.storage.md).StorageWriteResponse
...
- [constructor](grpc.storage.storagewriteresponse-1.md#constructor)

### Properties

- [extensions](grpc.storage.storagewriteresponse-1.md#extensions)
- [extensionsBinary](grpc.storage.storagewriteresponse-1.md#extensionsbinary)

### Methods

- [clone](grpc.storage.storagewriteresponse-1.md#clone)
- [cloneMessage](grpc.storage.storagewriteresponse-1.md#clonemessage)
- [getExtension](grpc.storage.storagewriteresponse-1.md#getextension)
- [getJsPbMessageId](grpc.storage.storagewriteresponse-1.md#getjspbmessageid)
- [readBinaryExtension](grpc.storage.storagewriteresponse-1.md#readbinaryextension)
- [serializeBinary](grpc.storage.storagewriteresponse-1.md#serializebinary)
- [serializeBinaryExtensions](grpc.storage.storagewriteresponse-1.md#serializebinaryextensions)
- [setExtension](grpc.storage.storagewriteresponse-1.md#setextension)
- [toArray](grpc.storage.storagewriteresponse-1.md#toarray)
- [toObject](grpc.storage.storagewriteresponse-1.md#toobject)
- [toString](grpc.storage.storagewriteresponse-1.md#tostring)
- [addToRepeatedField](grpc.storage.storagewriteresponse-1.md#addtorepeatedfield)
- [addToRepeatedWrapperField](grpc.storage.storagewriteresponse-1.md#addtorepeatedwrapperfield)
- [bytesAsB64](grpc.storage.storagewriteresponse-1.md#bytesasb64)
- [bytesAsU8](grpc.storage.storagewriteresponse-1.md#bytesasu8)
- [bytesListAsB64](grpc.storage.storagewriteresponse-1.md#byteslistasb64)
- [bytesListAsU8](grpc.storage.storagewriteresponse-1.md#byteslistasu8)
- [clone](grpc.storage.storagewriteresponse-1.md#clone)
- [cloneMessage](grpc.storage.storagewriteresponse-1.md#clonemessage)
- [compareExtensions](grpc.storage.storagewriteresponse-1.md#compareextensions)
- [compareFields](grpc.storage.storagewriteresponse-1.md#comparefields)
- [computeOneofCase](grpc.storage.storagewriteresponse-1.md#computeoneofcase)
- [copyInto](grpc.storage.storagewriteresponse-1.md#copyinto)
- [deserializeBinary](grpc.storage.storagewriteresponse-1.md#deserializebinary)
- [deserializeBinaryFromReader](grpc.storage.storagewriteresponse-1.md#deserializebinaryfromreader)
- [difference](grpc.storage.storagewriteresponse-1.md#difference)
- [equals](grpc.storage.storagewriteresponse-1.md#equals)
- [getField](grpc.storage.storagewriteresponse-1.md#getfield)
- [getFieldWithDefault](grpc.storage.storagewriteresponse-1.md#getfieldwithdefault)
- [getMapField](grpc.storage.storagewriteresponse-1.md#getmapfield)
- [getOptionalFloatingPointField](grpc.storage.storagewriteresponse-1.md#getoptionalfloatingpointfield)
- [getRepeatedFloatingPointField](grpc.storage.storagewriteresponse-1.md#getrepeatedfloatingpointfield)
- [getRepeatedWrapperField](grpc.storage.storagewriteresponse-1.md#getrepeatedwrapperfield)
- [getWrapperField](grpc.storage.storagewriteresponse-1.md#getwrapperfield)
- [initialize](grpc.storage.storagewriteresponse-1.md#initialize)
- [registerMessageType](grpc.storage.storagewriteresponse-1.md#registermessagetype)
- [serializeBinaryToWriter](grpc.storage.storagewriteresponse-1.md#serializebinarytowriter)
- [setField](grpc.storage.storagewriteresponse-1.md#setfield)
- [setOneofField](grpc.storage.storagewriteresponse-1.md#setoneoffield)
- [setOneofWrapperField](grpc.storage.storagewriteresponse-1.md#setoneofwrapperfield)
- [setRepeatedWrapperField](grpc.storage.storagewriteresponse-1.md#setrepeatedwrapperfield)
- [setWrapperField](grpc.storage.storagewriteresponse-1.md#setwrapperfield)
- [toMap](grpc.storage.storagewriteresponse-1.md#tomap)
- [toObject](grpc.storage.storagewriteresponse-1.md#toobject)
- [toObjectExtension](grpc.storage.storagewriteresponse-1.md#toobjectextension)
- [toObjectList](grpc.storage.storagewriteresponse-1.md#toobjectlist)

## Constructors

### constructor

\+ **new StorageWriteResponse**(): [*StorageWriteResponse*](grpc.storage.storagewriteresponse-1.md)

**Returns:** [*StorageWriteResponse*](grpc.storage.storagewriteresponse-1.md)
...
Defined in: src/interfaces/storage/v1/storage_pb.d.ts:40
...
Defined in: src/interfaces/storage/v1/storage_pb.d.ts:41
...
Defined in: src/interfaces/storage/v1/storage_pb.d.ts:37
...
▸ **toObject**(`includeInstance?`: *boolean*): [*AsObject*](../modules/grpc.storage.storagewriteresponse.md#asobject)
...
**Returns:** [*AsObject*](../modules/grpc.storage.storagewriteresponse.md#asobject)

Overrides: jspb.Message.toObject

Defined in: src/interfaces/storage/v1/storage_pb.d.ts:38
...
▸ `Static`**deserializeBinary**(`bytes`: *Uint8Array*): [*StorageWriteResponse*](grpc.storage.storagewriteresponse-1.md)
...
Defined in: src/interfaces/storage/v1/storage_pb.d.ts:43

___

### deserializeBinaryFromReader

▸ `Static`**deserializeBinaryFromReader**(`message`: [*StorageWriteResponse*](grpc.storage.storagewriteresponse-1.md), `reader`: *BinaryReader*): [*StorageWriteResponse*](grpc.storage.storagewriteresponse-1.md)

#### Parameters:

Name | Type |
:------ | :------ |
`message` | [*StorageWriteResponse*](grpc.storage.storagewriteresponse-1.md) |
`reader` | *BinaryReader* |
...
Defined in: src/interfaces/storage/v1/storage_pb.d.ts:44
...
▸ `Static`**serializeBinaryToWriter**(`message`: [*StorageWriteResponse*](grpc.storage.storagewriteresponse-1.md), `writer`: *BinaryWriter*): *void*
...
Defined in: src/interfaces/storage/v1/storage_pb.d.ts:42
...
▸ `Static`**toObject**(`includeInstance`: *boolean*, `msg`: [*StorageWriteResponse*](grpc.storage.storagewriteresponse-1.md)): [*AsObject*](../modules/grpc.storage.storagewriteresponse.md#asobject)
...
:------ | :------ |
`includeInstance` | *boolean* |
`msg` | [*StorageWriteResponse*](grpc.storage.storagewriteresponse-1.md) |

**Returns:** [*AsObject*](../modules/grpc.storage.storagewriteresponse.md#asobject)

Overrides: jspb.Message.toObject

Defined in: src/interfaces/storage/v1/storage_pb.d.ts:39
