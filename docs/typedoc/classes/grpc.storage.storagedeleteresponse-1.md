[@nitric/sdk](../README.md) / [grpc](../modules/grpc.md) / [storage](../modules/grpc.storage.md) / StorageDeleteResponse

# Class: StorageDeleteResponse

[grpc](../modules/grpc.md).[storage](../modules/grpc.storage.md).StorageDeleteResponse
...
- [constructor](grpc.storage.storagedeleteresponse-1.md#constructor)

### Properties

- [extensions](grpc.storage.storagedeleteresponse-1.md#extensions)
- [extensionsBinary](grpc.storage.storagedeleteresponse-1.md#extensionsbinary)

### Methods

- [clone](grpc.storage.storagedeleteresponse-1.md#clone)
- [cloneMessage](grpc.storage.storagedeleteresponse-1.md#clonemessage)
- [getExtension](grpc.storage.storagedeleteresponse-1.md#getextension)
- [getJsPbMessageId](grpc.storage.storagedeleteresponse-1.md#getjspbmessageid)
- [readBinaryExtension](grpc.storage.storagedeleteresponse-1.md#readbinaryextension)
- [serializeBinary](grpc.storage.storagedeleteresponse-1.md#serializebinary)
- [serializeBinaryExtensions](grpc.storage.storagedeleteresponse-1.md#serializebinaryextensions)
- [setExtension](grpc.storage.storagedeleteresponse-1.md#setextension)
- [toArray](grpc.storage.storagedeleteresponse-1.md#toarray)
- [toObject](grpc.storage.storagedeleteresponse-1.md#toobject)
- [toString](grpc.storage.storagedeleteresponse-1.md#tostring)
- [addToRepeatedField](grpc.storage.storagedeleteresponse-1.md#addtorepeatedfield)
- [addToRepeatedWrapperField](grpc.storage.storagedeleteresponse-1.md#addtorepeatedwrapperfield)
- [bytesAsB64](grpc.storage.storagedeleteresponse-1.md#bytesasb64)
- [bytesAsU8](grpc.storage.storagedeleteresponse-1.md#bytesasu8)
- [bytesListAsB64](grpc.storage.storagedeleteresponse-1.md#byteslistasb64)
- [bytesListAsU8](grpc.storage.storagedeleteresponse-1.md#byteslistasu8)
- [clone](grpc.storage.storagedeleteresponse-1.md#clone)
- [cloneMessage](grpc.storage.storagedeleteresponse-1.md#clonemessage)
- [compareExtensions](grpc.storage.storagedeleteresponse-1.md#compareextensions)
- [compareFields](grpc.storage.storagedeleteresponse-1.md#comparefields)
- [computeOneofCase](grpc.storage.storagedeleteresponse-1.md#computeoneofcase)
- [copyInto](grpc.storage.storagedeleteresponse-1.md#copyinto)
- [deserializeBinary](grpc.storage.storagedeleteresponse-1.md#deserializebinary)
- [deserializeBinaryFromReader](grpc.storage.storagedeleteresponse-1.md#deserializebinaryfromreader)
- [difference](grpc.storage.storagedeleteresponse-1.md#difference)
- [equals](grpc.storage.storagedeleteresponse-1.md#equals)
- [getField](grpc.storage.storagedeleteresponse-1.md#getfield)
- [getFieldWithDefault](grpc.storage.storagedeleteresponse-1.md#getfieldwithdefault)
- [getMapField](grpc.storage.storagedeleteresponse-1.md#getmapfield)
- [getOptionalFloatingPointField](grpc.storage.storagedeleteresponse-1.md#getoptionalfloatingpointfield)
- [getRepeatedFloatingPointField](grpc.storage.storagedeleteresponse-1.md#getrepeatedfloatingpointfield)
- [getRepeatedWrapperField](grpc.storage.storagedeleteresponse-1.md#getrepeatedwrapperfield)
- [getWrapperField](grpc.storage.storagedeleteresponse-1.md#getwrapperfield)
- [initialize](grpc.storage.storagedeleteresponse-1.md#initialize)
- [registerMessageType](grpc.storage.storagedeleteresponse-1.md#registermessagetype)
- [serializeBinaryToWriter](grpc.storage.storagedeleteresponse-1.md#serializebinarytowriter)
- [setField](grpc.storage.storagedeleteresponse-1.md#setfield)
- [setOneofField](grpc.storage.storagedeleteresponse-1.md#setoneoffield)
- [setOneofWrapperField](grpc.storage.storagedeleteresponse-1.md#setoneofwrapperfield)
- [setRepeatedWrapperField](grpc.storage.storagedeleteresponse-1.md#setrepeatedwrapperfield)
- [setWrapperField](grpc.storage.storagedeleteresponse-1.md#setwrapperfield)
- [toMap](grpc.storage.storagedeleteresponse-1.md#tomap)
- [toObject](grpc.storage.storagedeleteresponse-1.md#toobject)
- [toObjectExtension](grpc.storage.storagedeleteresponse-1.md#toobjectextension)
- [toObjectList](grpc.storage.storagedeleteresponse-1.md#toobjectlist)

## Constructors

### constructor

\+ **new StorageDeleteResponse**(): [*StorageDeleteResponse*](grpc.storage.storagedeleteresponse-1.md)

**Returns:** [*StorageDeleteResponse*](grpc.storage.storagedeleteresponse-1.md)
...
Defined in: src/interfaces/storage/v1/storage_pb.d.ts:126
...
Defined in: src/interfaces/storage/v1/storage_pb.d.ts:127
...
Defined in: src/interfaces/storage/v1/storage_pb.d.ts:123
...
▸ **toObject**(`includeInstance?`: *boolean*): [*AsObject*](../modules/grpc.storage.storagedeleteresponse.md#asobject)
...
**Returns:** [*AsObject*](../modules/grpc.storage.storagedeleteresponse.md#asobject)

Overrides: jspb.Message.toObject

Defined in: src/interfaces/storage/v1/storage_pb.d.ts:124
...
▸ `Static`**deserializeBinary**(`bytes`: *Uint8Array*): [*StorageDeleteResponse*](grpc.storage.storagedeleteresponse-1.md)
...
Defined in: src/interfaces/storage/v1/storage_pb.d.ts:129

___

### deserializeBinaryFromReader

▸ `Static`**deserializeBinaryFromReader**(`message`: [*StorageDeleteResponse*](grpc.storage.storagedeleteresponse-1.md), `reader`: *BinaryReader*): [*StorageDeleteResponse*](grpc.storage.storagedeleteresponse-1.md)

#### Parameters:

Name | Type |
:------ | :------ |
`message` | [*StorageDeleteResponse*](grpc.storage.storagedeleteresponse-1.md) |
`reader` | *BinaryReader* |
...
Defined in: src/interfaces/storage/v1/storage_pb.d.ts:130
...
▸ `Static`**serializeBinaryToWriter**(`message`: [*StorageDeleteResponse*](grpc.storage.storagedeleteresponse-1.md), `writer`: *BinaryWriter*): *void*
...
Defined in: src/interfaces/storage/v1/storage_pb.d.ts:128
...
▸ `Static`**toObject**(`includeInstance`: *boolean*, `msg`: [*StorageDeleteResponse*](grpc.storage.storagedeleteresponse-1.md)): [*AsObject*](../modules/grpc.storage.storagedeleteresponse.md#asobject)
...
:------ | :------ |
`includeInstance` | *boolean* |
`msg` | [*StorageDeleteResponse*](grpc.storage.storagedeleteresponse-1.md) |

**Returns:** [*AsObject*](../modules/grpc.storage.storagedeleteresponse.md#asobject)

Overrides: jspb.Message.toObject

Defined in: src/interfaces/storage/v1/storage_pb.d.ts:125
