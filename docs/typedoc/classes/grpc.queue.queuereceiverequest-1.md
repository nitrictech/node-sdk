[@nitric/sdk](../README.md) / [grpc](../modules/grpc.md) / [queue](../modules/grpc.queue.md) / QueueReceiveRequest

# Class: QueueReceiveRequest

[grpc](../modules/grpc.md).[queue](../modules/grpc.queue.md).QueueReceiveRequest
...
- [constructor](grpc.queue.queuereceiverequest-1.md#constructor)

### Properties

- [extensions](grpc.queue.queuereceiverequest-1.md#extensions)
- [extensionsBinary](grpc.queue.queuereceiverequest-1.md#extensionsbinary)

### Methods

- [clone](grpc.queue.queuereceiverequest-1.md#clone)
- [cloneMessage](grpc.queue.queuereceiverequest-1.md#clonemessage)
- [getDepth](grpc.queue.queuereceiverequest-1.md#getdepth)
- [getExtension](grpc.queue.queuereceiverequest-1.md#getextension)
- [getJsPbMessageId](grpc.queue.queuereceiverequest-1.md#getjspbmessageid)
- [getQueue](grpc.queue.queuereceiverequest-1.md#getqueue)
- [readBinaryExtension](grpc.queue.queuereceiverequest-1.md#readbinaryextension)
- [serializeBinary](grpc.queue.queuereceiverequest-1.md#serializebinary)
- [serializeBinaryExtensions](grpc.queue.queuereceiverequest-1.md#serializebinaryextensions)
- [setDepth](grpc.queue.queuereceiverequest-1.md#setdepth)
- [setExtension](grpc.queue.queuereceiverequest-1.md#setextension)
- [setQueue](grpc.queue.queuereceiverequest-1.md#setqueue)
- [toArray](grpc.queue.queuereceiverequest-1.md#toarray)
- [toObject](grpc.queue.queuereceiverequest-1.md#toobject)
- [toString](grpc.queue.queuereceiverequest-1.md#tostring)
- [addToRepeatedField](grpc.queue.queuereceiverequest-1.md#addtorepeatedfield)
- [addToRepeatedWrapperField](grpc.queue.queuereceiverequest-1.md#addtorepeatedwrapperfield)
- [bytesAsB64](grpc.queue.queuereceiverequest-1.md#bytesasb64)
- [bytesAsU8](grpc.queue.queuereceiverequest-1.md#bytesasu8)
- [bytesListAsB64](grpc.queue.queuereceiverequest-1.md#byteslistasb64)
- [bytesListAsU8](grpc.queue.queuereceiverequest-1.md#byteslistasu8)
- [clone](grpc.queue.queuereceiverequest-1.md#clone)
- [cloneMessage](grpc.queue.queuereceiverequest-1.md#clonemessage)
- [compareExtensions](grpc.queue.queuereceiverequest-1.md#compareextensions)
- [compareFields](grpc.queue.queuereceiverequest-1.md#comparefields)
- [computeOneofCase](grpc.queue.queuereceiverequest-1.md#computeoneofcase)
- [copyInto](grpc.queue.queuereceiverequest-1.md#copyinto)
- [deserializeBinary](grpc.queue.queuereceiverequest-1.md#deserializebinary)
- [deserializeBinaryFromReader](grpc.queue.queuereceiverequest-1.md#deserializebinaryfromreader)
- [difference](grpc.queue.queuereceiverequest-1.md#difference)
- [equals](grpc.queue.queuereceiverequest-1.md#equals)
- [getField](grpc.queue.queuereceiverequest-1.md#getfield)
- [getFieldWithDefault](grpc.queue.queuereceiverequest-1.md#getfieldwithdefault)
- [getMapField](grpc.queue.queuereceiverequest-1.md#getmapfield)
- [getOptionalFloatingPointField](grpc.queue.queuereceiverequest-1.md#getoptionalfloatingpointfield)
- [getRepeatedFloatingPointField](grpc.queue.queuereceiverequest-1.md#getrepeatedfloatingpointfield)
- [getRepeatedWrapperField](grpc.queue.queuereceiverequest-1.md#getrepeatedwrapperfield)
- [getWrapperField](grpc.queue.queuereceiverequest-1.md#getwrapperfield)
- [initialize](grpc.queue.queuereceiverequest-1.md#initialize)
- [registerMessageType](grpc.queue.queuereceiverequest-1.md#registermessagetype)
- [serializeBinaryToWriter](grpc.queue.queuereceiverequest-1.md#serializebinarytowriter)
- [setField](grpc.queue.queuereceiverequest-1.md#setfield)
- [setOneofField](grpc.queue.queuereceiverequest-1.md#setoneoffield)
- [setOneofWrapperField](grpc.queue.queuereceiverequest-1.md#setoneofwrapperfield)
- [setRepeatedWrapperField](grpc.queue.queuereceiverequest-1.md#setrepeatedwrapperfield)
- [setWrapperField](grpc.queue.queuereceiverequest-1.md#setwrapperfield)
- [toMap](grpc.queue.queuereceiverequest-1.md#tomap)
- [toObject](grpc.queue.queuereceiverequest-1.md#toobject)
- [toObjectExtension](grpc.queue.queuereceiverequest-1.md#toobjectextension)
- [toObjectList](grpc.queue.queuereceiverequest-1.md#toobjectlist)

## Constructors

### constructor

\+ **new QueueReceiveRequest**(): [*QueueReceiveRequest*](grpc.queue.queuereceiverequest-1.md)

**Returns:** [*QueueReceiveRequest*](grpc.queue.queuereceiverequest-1.md)
...
Defined in: src/interfaces/queue/v1/queue_pb.d.ts:107
...
Defined in: src/interfaces/queue/v1/queue_pb.d.ts:108
...
Defined in: src/interfaces/queue/v1/queue_pb.d.ts:101
...
Defined in: src/interfaces/queue/v1/queue_pb.d.ts:98
...
Defined in: src/interfaces/queue/v1/queue_pb.d.ts:104
...
Defined in: src/interfaces/queue/v1/queue_pb.d.ts:102
...
Defined in: src/interfaces/queue/v1/queue_pb.d.ts:99
...
▸ **toObject**(`includeInstance?`: *boolean*): [*AsObject*](../modules/grpc.queue.queuereceiverequest.md#asobject)
...
**Returns:** [*AsObject*](../modules/grpc.queue.queuereceiverequest.md#asobject)

Overrides: jspb.Message.toObject

Defined in: src/interfaces/queue/v1/queue_pb.d.ts:105
...
▸ `Static`**deserializeBinary**(`bytes`: *Uint8Array*): [*QueueReceiveRequest*](grpc.queue.queuereceiverequest-1.md)
...
Defined in: src/interfaces/queue/v1/queue_pb.d.ts:110

___

### deserializeBinaryFromReader

▸ `Static`**deserializeBinaryFromReader**(`message`: [*QueueReceiveRequest*](grpc.queue.queuereceiverequest-1.md), `reader`: *BinaryReader*): [*QueueReceiveRequest*](grpc.queue.queuereceiverequest-1.md)

#### Parameters:

Name | Type |
:------ | :------ |
`message` | [*QueueReceiveRequest*](grpc.queue.queuereceiverequest-1.md) |
`reader` | *BinaryReader* |
...
Defined in: src/interfaces/queue/v1/queue_pb.d.ts:111
...
▸ `Static`**serializeBinaryToWriter**(`message`: [*QueueReceiveRequest*](grpc.queue.queuereceiverequest-1.md), `writer`: *BinaryWriter*): *void*
...
Defined in: src/interfaces/queue/v1/queue_pb.d.ts:109
...
▸ `Static`**toObject**(`includeInstance`: *boolean*, `msg`: [*QueueReceiveRequest*](grpc.queue.queuereceiverequest-1.md)): [*AsObject*](../modules/grpc.queue.queuereceiverequest.md#asobject)
...
:------ | :------ |
`includeInstance` | *boolean* |
`msg` | [*QueueReceiveRequest*](grpc.queue.queuereceiverequest-1.md) |

**Returns:** [*AsObject*](../modules/grpc.queue.queuereceiverequest.md#asobject)

Overrides: jspb.Message.toObject

Defined in: src/interfaces/queue/v1/queue_pb.d.ts:106
