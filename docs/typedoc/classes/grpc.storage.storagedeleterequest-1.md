[@nitric/sdk](../README.md) / [grpc](../modules/grpc.md) / [storage](../modules/grpc.storage.md) / StorageDeleteRequest

# Class: StorageDeleteRequest

[grpc](../modules/grpc.md).[storage](../modules/grpc.storage.md).StorageDeleteRequest
...
- [constructor](grpc.storage.storagedeleterequest-1.md#constructor)

### Properties

- [extensions](grpc.storage.storagedeleterequest-1.md#extensions)
- [extensionsBinary](grpc.storage.storagedeleterequest-1.md#extensionsbinary)

### Methods

- [clone](grpc.storage.storagedeleterequest-1.md#clone)
- [cloneMessage](grpc.storage.storagedeleterequest-1.md#clonemessage)
- [getBucketName](grpc.storage.storagedeleterequest-1.md#getbucketname)
- [getExtension](grpc.storage.storagedeleterequest-1.md#getextension)
- [getJsPbMessageId](grpc.storage.storagedeleterequest-1.md#getjspbmessageid)
- [getKey](grpc.storage.storagedeleterequest-1.md#getkey)
- [readBinaryExtension](grpc.storage.storagedeleterequest-1.md#readbinaryextension)
- [serializeBinary](grpc.storage.storagedeleterequest-1.md#serializebinary)
- [serializeBinaryExtensions](grpc.storage.storagedeleterequest-1.md#serializebinaryextensions)
- [setBucketName](grpc.storage.storagedeleterequest-1.md#setbucketname)
- [setExtension](grpc.storage.storagedeleterequest-1.md#setextension)
- [setKey](grpc.storage.storagedeleterequest-1.md#setkey)
- [toArray](grpc.storage.storagedeleterequest-1.md#toarray)
- [toObject](grpc.storage.storagedeleterequest-1.md#toobject)
- [toString](grpc.storage.storagedeleterequest-1.md#tostring)
- [addToRepeatedField](grpc.storage.storagedeleterequest-1.md#addtorepeatedfield)
- [addToRepeatedWrapperField](grpc.storage.storagedeleterequest-1.md#addtorepeatedwrapperfield)
- [bytesAsB64](grpc.storage.storagedeleterequest-1.md#bytesasb64)
- [bytesAsU8](grpc.storage.storagedeleterequest-1.md#bytesasu8)
- [bytesListAsB64](grpc.storage.storagedeleterequest-1.md#byteslistasb64)
- [bytesListAsU8](grpc.storage.storagedeleterequest-1.md#byteslistasu8)
- [clone](grpc.storage.storagedeleterequest-1.md#clone)
- [cloneMessage](grpc.storage.storagedeleterequest-1.md#clonemessage)
- [compareExtensions](grpc.storage.storagedeleterequest-1.md#compareextensions)
- [compareFields](grpc.storage.storagedeleterequest-1.md#comparefields)
- [computeOneofCase](grpc.storage.storagedeleterequest-1.md#computeoneofcase)
- [copyInto](grpc.storage.storagedeleterequest-1.md#copyinto)
- [deserializeBinary](grpc.storage.storagedeleterequest-1.md#deserializebinary)
- [deserializeBinaryFromReader](grpc.storage.storagedeleterequest-1.md#deserializebinaryfromreader)
- [difference](grpc.storage.storagedeleterequest-1.md#difference)
- [equals](grpc.storage.storagedeleterequest-1.md#equals)
- [getField](grpc.storage.storagedeleterequest-1.md#getfield)
- [getFieldWithDefault](grpc.storage.storagedeleterequest-1.md#getfieldwithdefault)
- [getMapField](grpc.storage.storagedeleterequest-1.md#getmapfield)
- [getOptionalFloatingPointField](grpc.storage.storagedeleterequest-1.md#getoptionalfloatingpointfield)
- [getRepeatedFloatingPointField](grpc.storage.storagedeleterequest-1.md#getrepeatedfloatingpointfield)
- [getRepeatedWrapperField](grpc.storage.storagedeleterequest-1.md#getrepeatedwrapperfield)
- [getWrapperField](grpc.storage.storagedeleterequest-1.md#getwrapperfield)
- [initialize](grpc.storage.storagedeleterequest-1.md#initialize)
- [registerMessageType](grpc.storage.storagedeleterequest-1.md#registermessagetype)
- [serializeBinaryToWriter](grpc.storage.storagedeleterequest-1.md#serializebinarytowriter)
- [setField](grpc.storage.storagedeleterequest-1.md#setfield)
- [setOneofField](grpc.storage.storagedeleterequest-1.md#setoneoffield)
- [setOneofWrapperField](grpc.storage.storagedeleterequest-1.md#setoneofwrapperfield)
- [setRepeatedWrapperField](grpc.storage.storagedeleterequest-1.md#setrepeatedwrapperfield)
- [setWrapperField](grpc.storage.storagedeleterequest-1.md#setwrapperfield)
- [toMap](grpc.storage.storagedeleterequest-1.md#tomap)
- [toObject](grpc.storage.storagedeleterequest-1.md#toobject)
- [toObjectExtension](grpc.storage.storagedeleterequest-1.md#toobjectextension)
- [toObjectList](grpc.storage.storagedeleterequest-1.md#toobjectlist)

## Constructors

### constructor

\+ **new StorageDeleteRequest**(): [*StorageDeleteRequest*](grpc.storage.storagedeleterequest-1.md)

**Returns:** [*StorageDeleteRequest*](grpc.storage.storagedeleterequest-1.md)
...
Defined in: src/interfaces/storage/v1/storage_pb.d.ts:108
...
Defined in: src/interfaces/storage/v1/storage_pb.d.ts:109
...
Defined in: src/interfaces/storage/v1/storage_pb.d.ts:99
...
Defined in: src/interfaces/storage/v1/storage_pb.d.ts:102
...
Defined in: src/interfaces/storage/v1/storage_pb.d.ts:105
...
Defined in: src/interfaces/storage/v1/storage_pb.d.ts:100
...
Defined in: src/interfaces/storage/v1/storage_pb.d.ts:103
...
▸ **toObject**(`includeInstance?`: *boolean*): [*AsObject*](../modules/grpc.storage.storagedeleterequest.md#asobject)
...
**Returns:** [*AsObject*](../modules/grpc.storage.storagedeleterequest.md#asobject)

Overrides: jspb.Message.toObject

Defined in: src/interfaces/storage/v1/storage_pb.d.ts:106
...
▸ `Static`**deserializeBinary**(`bytes`: *Uint8Array*): [*StorageDeleteRequest*](grpc.storage.storagedeleterequest-1.md)
...
Defined in: src/interfaces/storage/v1/storage_pb.d.ts:111

___

### deserializeBinaryFromReader

▸ `Static`**deserializeBinaryFromReader**(`message`: [*StorageDeleteRequest*](grpc.storage.storagedeleterequest-1.md), `reader`: *BinaryReader*): [*StorageDeleteRequest*](grpc.storage.storagedeleterequest-1.md)

#### Parameters:

Name | Type |
:------ | :------ |
`message` | [*StorageDeleteRequest*](grpc.storage.storagedeleterequest-1.md) |
`reader` | *BinaryReader* |
...
Defined in: src/interfaces/storage/v1/storage_pb.d.ts:112
...
▸ `Static`**serializeBinaryToWriter**(`message`: [*StorageDeleteRequest*](grpc.storage.storagedeleterequest-1.md), `writer`: *BinaryWriter*): *void*
...
Defined in: src/interfaces/storage/v1/storage_pb.d.ts:110
...
▸ `Static`**toObject**(`includeInstance`: *boolean*, `msg`: [*StorageDeleteRequest*](grpc.storage.storagedeleterequest-1.md)): [*AsObject*](../modules/grpc.storage.storagedeleterequest.md#asobject)
...
:------ | :------ |
`includeInstance` | *boolean* |
`msg` | [*StorageDeleteRequest*](grpc.storage.storagedeleterequest-1.md) |

**Returns:** [*AsObject*](../modules/grpc.storage.storagedeleterequest.md#asobject)

Overrides: jspb.Message.toObject

Defined in: src/interfaces/storage/v1/storage_pb.d.ts:107
