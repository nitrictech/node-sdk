[@nitric/sdk](../README.md) / [grpc](../modules/grpc.md) / [queue](../modules/grpc.queue.md) / QueueCompleteResponse

# Class: QueueCompleteResponse

[grpc](../modules/grpc.md).[queue](../modules/grpc.queue.md).QueueCompleteResponse
...
- [constructor](grpc.queue.queuecompleteresponse-1.md#constructor)

### Properties

- [extensions](grpc.queue.queuecompleteresponse-1.md#extensions)
- [extensionsBinary](grpc.queue.queuecompleteresponse-1.md#extensionsbinary)

### Methods

- [clone](grpc.queue.queuecompleteresponse-1.md#clone)
- [cloneMessage](grpc.queue.queuecompleteresponse-1.md#clonemessage)
- [getExtension](grpc.queue.queuecompleteresponse-1.md#getextension)
- [getJsPbMessageId](grpc.queue.queuecompleteresponse-1.md#getjspbmessageid)
- [readBinaryExtension](grpc.queue.queuecompleteresponse-1.md#readbinaryextension)
- [serializeBinary](grpc.queue.queuecompleteresponse-1.md#serializebinary)
- [serializeBinaryExtensions](grpc.queue.queuecompleteresponse-1.md#serializebinaryextensions)
- [setExtension](grpc.queue.queuecompleteresponse-1.md#setextension)
- [toArray](grpc.queue.queuecompleteresponse-1.md#toarray)
- [toObject](grpc.queue.queuecompleteresponse-1.md#toobject)
- [toString](grpc.queue.queuecompleteresponse-1.md#tostring)
- [addToRepeatedField](grpc.queue.queuecompleteresponse-1.md#addtorepeatedfield)
- [addToRepeatedWrapperField](grpc.queue.queuecompleteresponse-1.md#addtorepeatedwrapperfield)
- [bytesAsB64](grpc.queue.queuecompleteresponse-1.md#bytesasb64)
- [bytesAsU8](grpc.queue.queuecompleteresponse-1.md#bytesasu8)
- [bytesListAsB64](grpc.queue.queuecompleteresponse-1.md#byteslistasb64)
- [bytesListAsU8](grpc.queue.queuecompleteresponse-1.md#byteslistasu8)
- [clone](grpc.queue.queuecompleteresponse-1.md#clone)
- [cloneMessage](grpc.queue.queuecompleteresponse-1.md#clonemessage)
- [compareExtensions](grpc.queue.queuecompleteresponse-1.md#compareextensions)
- [compareFields](grpc.queue.queuecompleteresponse-1.md#comparefields)
- [computeOneofCase](grpc.queue.queuecompleteresponse-1.md#computeoneofcase)
- [copyInto](grpc.queue.queuecompleteresponse-1.md#copyinto)
- [deserializeBinary](grpc.queue.queuecompleteresponse-1.md#deserializebinary)
- [deserializeBinaryFromReader](grpc.queue.queuecompleteresponse-1.md#deserializebinaryfromreader)
- [difference](grpc.queue.queuecompleteresponse-1.md#difference)
- [equals](grpc.queue.queuecompleteresponse-1.md#equals)
- [getField](grpc.queue.queuecompleteresponse-1.md#getfield)
- [getFieldWithDefault](grpc.queue.queuecompleteresponse-1.md#getfieldwithdefault)
- [getMapField](grpc.queue.queuecompleteresponse-1.md#getmapfield)
- [getOptionalFloatingPointField](grpc.queue.queuecompleteresponse-1.md#getoptionalfloatingpointfield)
- [getRepeatedFloatingPointField](grpc.queue.queuecompleteresponse-1.md#getrepeatedfloatingpointfield)
- [getRepeatedWrapperField](grpc.queue.queuecompleteresponse-1.md#getrepeatedwrapperfield)
- [getWrapperField](grpc.queue.queuecompleteresponse-1.md#getwrapperfield)
- [initialize](grpc.queue.queuecompleteresponse-1.md#initialize)
- [registerMessageType](grpc.queue.queuecompleteresponse-1.md#registermessagetype)
- [serializeBinaryToWriter](grpc.queue.queuecompleteresponse-1.md#serializebinarytowriter)
- [setField](grpc.queue.queuecompleteresponse-1.md#setfield)
- [setOneofField](grpc.queue.queuecompleteresponse-1.md#setoneoffield)
- [setOneofWrapperField](grpc.queue.queuecompleteresponse-1.md#setoneofwrapperfield)
- [setRepeatedWrapperField](grpc.queue.queuecompleteresponse-1.md#setrepeatedwrapperfield)
- [setWrapperField](grpc.queue.queuecompleteresponse-1.md#setwrapperfield)
- [toMap](grpc.queue.queuecompleteresponse-1.md#tomap)
- [toObject](grpc.queue.queuecompleteresponse-1.md#toobject)
- [toObjectExtension](grpc.queue.queuecompleteresponse-1.md#toobjectextension)
- [toObjectList](grpc.queue.queuecompleteresponse-1.md#toobjectlist)

## Constructors

### constructor

\+ **new QueueCompleteResponse**(): [*QueueCompleteResponse*](grpc.queue.queuecompleteresponse-1.md)

**Returns:** [*QueueCompleteResponse*](grpc.queue.queuecompleteresponse-1.md)
...
Defined in: src/interfaces/queue/v1/queue_pb.d.ts:171
...
Defined in: src/interfaces/queue/v1/queue_pb.d.ts:172
...
Defined in: src/interfaces/queue/v1/queue_pb.d.ts:168
...
▸ **toObject**(`includeInstance?`: *boolean*): [*AsObject*](../modules/grpc.queue.queuecompleteresponse.md#asobject)
...
**Returns:** [*AsObject*](../modules/grpc.queue.queuecompleteresponse.md#asobject)

Overrides: jspb.Message.toObject

Defined in: src/interfaces/queue/v1/queue_pb.d.ts:169
...
▸ `Static`**deserializeBinary**(`bytes`: *Uint8Array*): [*QueueCompleteResponse*](grpc.queue.queuecompleteresponse-1.md)
...
Defined in: src/interfaces/queue/v1/queue_pb.d.ts:174

___

### deserializeBinaryFromReader

▸ `Static`**deserializeBinaryFromReader**(`message`: [*QueueCompleteResponse*](grpc.queue.queuecompleteresponse-1.md), `reader`: *BinaryReader*): [*QueueCompleteResponse*](grpc.queue.queuecompleteresponse-1.md)

#### Parameters:

Name | Type |
:------ | :------ |
`message` | [*QueueCompleteResponse*](grpc.queue.queuecompleteresponse-1.md) |
`reader` | *BinaryReader* |
...
Defined in: src/interfaces/queue/v1/queue_pb.d.ts:175
...
▸ `Static`**serializeBinaryToWriter**(`message`: [*QueueCompleteResponse*](grpc.queue.queuecompleteresponse-1.md), `writer`: *BinaryWriter*): *void*
...
Defined in: src/interfaces/queue/v1/queue_pb.d.ts:173
...
▸ `Static`**toObject**(`includeInstance`: *boolean*, `msg`: [*QueueCompleteResponse*](grpc.queue.queuecompleteresponse-1.md)): [*AsObject*](../modules/grpc.queue.queuecompleteresponse.md#asobject)
...
:------ | :------ |
`includeInstance` | *boolean* |
`msg` | [*QueueCompleteResponse*](grpc.queue.queuecompleteresponse-1.md) |

**Returns:** [*AsObject*](../modules/grpc.queue.queuecompleteresponse.md#asobject)

Overrides: jspb.Message.toObject

Defined in: src/interfaces/queue/v1/queue_pb.d.ts:170
