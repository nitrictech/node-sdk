[@nitric/sdk](../README.md) / [grpc](../modules/grpc.md) / [event](../modules/grpc.event.md) / NitricTopic

# Class: NitricTopic

[grpc](../modules/grpc.md).[event](../modules/grpc.event.md).NitricTopic
...
- [constructor](grpc.event.nitrictopic-1.md#constructor)

### Properties

- [extensions](grpc.event.nitrictopic-1.md#extensions)
- [extensionsBinary](grpc.event.nitrictopic-1.md#extensionsbinary)

### Methods

- [clone](grpc.event.nitrictopic-1.md#clone)
- [cloneMessage](grpc.event.nitrictopic-1.md#clonemessage)
- [getExtension](grpc.event.nitrictopic-1.md#getextension)
- [getJsPbMessageId](grpc.event.nitrictopic-1.md#getjspbmessageid)
- [getName](grpc.event.nitrictopic-1.md#getname)
- [readBinaryExtension](grpc.event.nitrictopic-1.md#readbinaryextension)
- [serializeBinary](grpc.event.nitrictopic-1.md#serializebinary)
- [serializeBinaryExtensions](grpc.event.nitrictopic-1.md#serializebinaryextensions)
- [setExtension](grpc.event.nitrictopic-1.md#setextension)
- [setName](grpc.event.nitrictopic-1.md#setname)
- [toArray](grpc.event.nitrictopic-1.md#toarray)
- [toObject](grpc.event.nitrictopic-1.md#toobject)
- [toString](grpc.event.nitrictopic-1.md#tostring)
- [addToRepeatedField](grpc.event.nitrictopic-1.md#addtorepeatedfield)
- [addToRepeatedWrapperField](grpc.event.nitrictopic-1.md#addtorepeatedwrapperfield)
- [bytesAsB64](grpc.event.nitrictopic-1.md#bytesasb64)
- [bytesAsU8](grpc.event.nitrictopic-1.md#bytesasu8)
- [bytesListAsB64](grpc.event.nitrictopic-1.md#byteslistasb64)
- [bytesListAsU8](grpc.event.nitrictopic-1.md#byteslistasu8)
- [clone](grpc.event.nitrictopic-1.md#clone)
- [cloneMessage](grpc.event.nitrictopic-1.md#clonemessage)
- [compareExtensions](grpc.event.nitrictopic-1.md#compareextensions)
- [compareFields](grpc.event.nitrictopic-1.md#comparefields)
- [computeOneofCase](grpc.event.nitrictopic-1.md#computeoneofcase)
- [copyInto](grpc.event.nitrictopic-1.md#copyinto)
- [deserializeBinary](grpc.event.nitrictopic-1.md#deserializebinary)
- [deserializeBinaryFromReader](grpc.event.nitrictopic-1.md#deserializebinaryfromreader)
- [difference](grpc.event.nitrictopic-1.md#difference)
- [equals](grpc.event.nitrictopic-1.md#equals)
- [getField](grpc.event.nitrictopic-1.md#getfield)
- [getFieldWithDefault](grpc.event.nitrictopic-1.md#getfieldwithdefault)
- [getMapField](grpc.event.nitrictopic-1.md#getmapfield)
- [getOptionalFloatingPointField](grpc.event.nitrictopic-1.md#getoptionalfloatingpointfield)
- [getRepeatedFloatingPointField](grpc.event.nitrictopic-1.md#getrepeatedfloatingpointfield)
- [getRepeatedWrapperField](grpc.event.nitrictopic-1.md#getrepeatedwrapperfield)
- [getWrapperField](grpc.event.nitrictopic-1.md#getwrapperfield)
- [initialize](grpc.event.nitrictopic-1.md#initialize)
- [registerMessageType](grpc.event.nitrictopic-1.md#registermessagetype)
- [serializeBinaryToWriter](grpc.event.nitrictopic-1.md#serializebinarytowriter)
- [setField](grpc.event.nitrictopic-1.md#setfield)
- [setOneofField](grpc.event.nitrictopic-1.md#setoneoffield)
- [setOneofWrapperField](grpc.event.nitrictopic-1.md#setoneofwrapperfield)
- [setRepeatedWrapperField](grpc.event.nitrictopic-1.md#setrepeatedwrapperfield)
- [setWrapperField](grpc.event.nitrictopic-1.md#setwrapperfield)
- [toMap](grpc.event.nitrictopic-1.md#tomap)
- [toObject](grpc.event.nitrictopic-1.md#toobject)
- [toObjectExtension](grpc.event.nitrictopic-1.md#toobjectextension)
- [toObjectList](grpc.event.nitrictopic-1.md#toobjectlist)

## Constructors

### constructor

\+ **new NitricTopic**(): [*NitricTopic*](grpc.event.nitrictopic-1.md)
...
Defined in: src/interfaces/event/v1/event_pb.d.ts:98
...
Defined in: src/interfaces/event/v1/event_pb.d.ts:99
...
Defined in: src/interfaces/event/v1/event_pb.d.ts:92
...
Defined in: src/interfaces/event/v1/event_pb.d.ts:95
...
Defined in: src/interfaces/event/v1/event_pb.d.ts:93
...
▸ **toObject**(`includeInstance?`: *boolean*): [*AsObject*](../modules/grpc.event.nitrictopic.md#asobject)
...
**Returns:** [*AsObject*](../modules/grpc.event.nitrictopic.md#asobject)

Overrides: jspb.Message.toObject

Defined in: src/interfaces/event/v1/event_pb.d.ts:96
...
▸ `Static`**deserializeBinary**(`bytes`: *Uint8Array*): [*NitricTopic*](grpc.event.nitrictopic-1.md)
...
Defined in: src/interfaces/event/v1/event_pb.d.ts:101

___

### deserializeBinaryFromReader

▸ `Static`**deserializeBinaryFromReader**(`message`: [*NitricTopic*](grpc.event.nitrictopic-1.md), `reader`: *BinaryReader*): [*NitricTopic*](grpc.event.nitrictopic-1.md)

#### Parameters:

Name | Type |
:------ | :------ |
`message` | [*NitricTopic*](grpc.event.nitrictopic-1.md) |
`reader` | *BinaryReader* |
...
Defined in: src/interfaces/event/v1/event_pb.d.ts:102
...
▸ `Static`**serializeBinaryToWriter**(`message`: [*NitricTopic*](grpc.event.nitrictopic-1.md), `writer`: *BinaryWriter*): *void*
...
Defined in: src/interfaces/event/v1/event_pb.d.ts:100
...
▸ `Static`**toObject**(`includeInstance`: *boolean*, `msg`: [*NitricTopic*](grpc.event.nitrictopic-1.md)): [*AsObject*](../modules/grpc.event.nitrictopic.md#asobject)
...
:------ | :------ |
`includeInstance` | *boolean* |
`msg` | [*NitricTopic*](grpc.event.nitrictopic-1.md) |

**Returns:** [*AsObject*](../modules/grpc.event.nitrictopic.md#asobject)

Overrides: jspb.Message.toObject

Defined in: src/interfaces/event/v1/event_pb.d.ts:97
