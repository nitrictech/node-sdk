...
Defined in: [src/api/topic/topic.ts:22](https://github.com/nitrictech/node-sdk/blob/3e510a5/src/api/topic/topic.ts#L22)
...
Defined in: [src/api/topic/topic.ts:47](https://github.com/nitrictech/node-sdk/blob/3e510a5/src/api/topic/topic.ts#L47)
