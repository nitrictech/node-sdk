...
Defined in: [src/api/topic/topic.ts:22](https://github.com/nitrictech/node-sdk/blob/ba26202/src/api/topic/topic.ts#L22)
...
Defined in: [src/api/topic/topic.ts:47](https://github.com/nitrictech/node-sdk/blob/ba26202/src/api/topic/topic.ts#L47)
