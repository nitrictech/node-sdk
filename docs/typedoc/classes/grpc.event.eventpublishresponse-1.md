[@nitric/sdk](../README.md) / [grpc](../modules/grpc.md) / [event](../modules/grpc.event.md) / EventPublishResponse

# Class: EventPublishResponse

[grpc](../modules/grpc.md).[event](../modules/grpc.event.md).EventPublishResponse
...
- [constructor](grpc.event.eventpublishresponse-1.md#constructor)

### Properties

- [extensions](grpc.event.eventpublishresponse-1.md#extensions)
- [extensionsBinary](grpc.event.eventpublishresponse-1.md#extensionsbinary)

### Methods

- [clone](grpc.event.eventpublishresponse-1.md#clone)
- [cloneMessage](grpc.event.eventpublishresponse-1.md#clonemessage)
- [getExtension](grpc.event.eventpublishresponse-1.md#getextension)
- [getId](grpc.event.eventpublishresponse-1.md#getid)
- [getJsPbMessageId](grpc.event.eventpublishresponse-1.md#getjspbmessageid)
- [readBinaryExtension](grpc.event.eventpublishresponse-1.md#readbinaryextension)
- [serializeBinary](grpc.event.eventpublishresponse-1.md#serializebinary)
- [serializeBinaryExtensions](grpc.event.eventpublishresponse-1.md#serializebinaryextensions)
- [setExtension](grpc.event.eventpublishresponse-1.md#setextension)
- [setId](grpc.event.eventpublishresponse-1.md#setid)
- [toArray](grpc.event.eventpublishresponse-1.md#toarray)
- [toObject](grpc.event.eventpublishresponse-1.md#toobject)
- [toString](grpc.event.eventpublishresponse-1.md#tostring)
- [addToRepeatedField](grpc.event.eventpublishresponse-1.md#addtorepeatedfield)
- [addToRepeatedWrapperField](grpc.event.eventpublishresponse-1.md#addtorepeatedwrapperfield)
- [bytesAsB64](grpc.event.eventpublishresponse-1.md#bytesasb64)
- [bytesAsU8](grpc.event.eventpublishresponse-1.md#bytesasu8)
- [bytesListAsB64](grpc.event.eventpublishresponse-1.md#byteslistasb64)
- [bytesListAsU8](grpc.event.eventpublishresponse-1.md#byteslistasu8)
- [clone](grpc.event.eventpublishresponse-1.md#clone)
- [cloneMessage](grpc.event.eventpublishresponse-1.md#clonemessage)
- [compareExtensions](grpc.event.eventpublishresponse-1.md#compareextensions)
- [compareFields](grpc.event.eventpublishresponse-1.md#comparefields)
- [computeOneofCase](grpc.event.eventpublishresponse-1.md#computeoneofcase)
- [copyInto](grpc.event.eventpublishresponse-1.md#copyinto)
- [deserializeBinary](grpc.event.eventpublishresponse-1.md#deserializebinary)
- [deserializeBinaryFromReader](grpc.event.eventpublishresponse-1.md#deserializebinaryfromreader)
- [difference](grpc.event.eventpublishresponse-1.md#difference)
- [equals](grpc.event.eventpublishresponse-1.md#equals)
- [getField](grpc.event.eventpublishresponse-1.md#getfield)
- [getFieldWithDefault](grpc.event.eventpublishresponse-1.md#getfieldwithdefault)
- [getMapField](grpc.event.eventpublishresponse-1.md#getmapfield)
- [getOptionalFloatingPointField](grpc.event.eventpublishresponse-1.md#getoptionalfloatingpointfield)
- [getRepeatedFloatingPointField](grpc.event.eventpublishresponse-1.md#getrepeatedfloatingpointfield)
- [getRepeatedWrapperField](grpc.event.eventpublishresponse-1.md#getrepeatedwrapperfield)
- [getWrapperField](grpc.event.eventpublishresponse-1.md#getwrapperfield)
- [initialize](grpc.event.eventpublishresponse-1.md#initialize)
- [registerMessageType](grpc.event.eventpublishresponse-1.md#registermessagetype)
- [serializeBinaryToWriter](grpc.event.eventpublishresponse-1.md#serializebinarytowriter)
- [setField](grpc.event.eventpublishresponse-1.md#setfield)
- [setOneofField](grpc.event.eventpublishresponse-1.md#setoneoffield)
- [setOneofWrapperField](grpc.event.eventpublishresponse-1.md#setoneofwrapperfield)
- [setRepeatedWrapperField](grpc.event.eventpublishresponse-1.md#setrepeatedwrapperfield)
- [setWrapperField](grpc.event.eventpublishresponse-1.md#setwrapperfield)
- [toMap](grpc.event.eventpublishresponse-1.md#tomap)
- [toObject](grpc.event.eventpublishresponse-1.md#toobject)
- [toObjectExtension](grpc.event.eventpublishresponse-1.md#toobjectextension)
- [toObjectList](grpc.event.eventpublishresponse-1.md#toobjectlist)

## Constructors

### constructor

\+ **new EventPublishResponse**(): [*EventPublishResponse*](grpc.event.eventpublishresponse-1.md)

**Returns:** [*EventPublishResponse*](grpc.event.eventpublishresponse-1.md)
...
Defined in: src/interfaces/event/v1/event_pb.d.ts:40
...
Defined in: src/interfaces/event/v1/event_pb.d.ts:41
...
Defined in: src/interfaces/event/v1/event_pb.d.ts:34
...
Defined in: src/interfaces/event/v1/event_pb.d.ts:37
...
Defined in: src/interfaces/event/v1/event_pb.d.ts:35
...
▸ **toObject**(`includeInstance?`: *boolean*): [*AsObject*](../modules/grpc.event.eventpublishresponse.md#asobject)
...
**Returns:** [*AsObject*](../modules/grpc.event.eventpublishresponse.md#asobject)

Overrides: jspb.Message.toObject

Defined in: src/interfaces/event/v1/event_pb.d.ts:38
...
▸ `Static`**deserializeBinary**(`bytes`: *Uint8Array*): [*EventPublishResponse*](grpc.event.eventpublishresponse-1.md)
...
Defined in: src/interfaces/event/v1/event_pb.d.ts:43

___

### deserializeBinaryFromReader

▸ `Static`**deserializeBinaryFromReader**(`message`: [*EventPublishResponse*](grpc.event.eventpublishresponse-1.md), `reader`: *BinaryReader*): [*EventPublishResponse*](grpc.event.eventpublishresponse-1.md)

#### Parameters:

Name | Type |
:------ | :------ |
`message` | [*EventPublishResponse*](grpc.event.eventpublishresponse-1.md) |
`reader` | *BinaryReader* |
...
Defined in: src/interfaces/event/v1/event_pb.d.ts:44
...
▸ `Static`**serializeBinaryToWriter**(`message`: [*EventPublishResponse*](grpc.event.eventpublishresponse-1.md), `writer`: *BinaryWriter*): *void*
...
Defined in: src/interfaces/event/v1/event_pb.d.ts:42
...
▸ `Static`**toObject**(`includeInstance`: *boolean*, `msg`: [*EventPublishResponse*](grpc.event.eventpublishresponse-1.md)): [*AsObject*](../modules/grpc.event.eventpublishresponse.md#asobject)
...
:------ | :------ |
`includeInstance` | *boolean* |
`msg` | [*EventPublishResponse*](grpc.event.eventpublishresponse-1.md) |

**Returns:** [*AsObject*](../modules/grpc.event.eventpublishresponse.md#asobject)

Overrides: jspb.Message.toObject

Defined in: src/interfaces/event/v1/event_pb.d.ts:39
