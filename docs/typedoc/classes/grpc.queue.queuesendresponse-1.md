[@nitric/sdk](../README.md) / [grpc](../modules/grpc.md) / [queue](../modules/grpc.queue.md) / QueueSendResponse

# Class: QueueSendResponse

[grpc](../modules/grpc.md).[queue](../modules/grpc.queue.md).QueueSendResponse
...
- [constructor](grpc.queue.queuesendresponse-1.md#constructor)

### Properties

- [extensions](grpc.queue.queuesendresponse-1.md#extensions)
- [extensionsBinary](grpc.queue.queuesendresponse-1.md#extensionsbinary)

### Methods

- [clone](grpc.queue.queuesendresponse-1.md#clone)
- [cloneMessage](grpc.queue.queuesendresponse-1.md#clonemessage)
- [getExtension](grpc.queue.queuesendresponse-1.md#getextension)
- [getJsPbMessageId](grpc.queue.queuesendresponse-1.md#getjspbmessageid)
- [readBinaryExtension](grpc.queue.queuesendresponse-1.md#readbinaryextension)
- [serializeBinary](grpc.queue.queuesendresponse-1.md#serializebinary)
- [serializeBinaryExtensions](grpc.queue.queuesendresponse-1.md#serializebinaryextensions)
- [setExtension](grpc.queue.queuesendresponse-1.md#setextension)
- [toArray](grpc.queue.queuesendresponse-1.md#toarray)
- [toObject](grpc.queue.queuesendresponse-1.md#toobject)
- [toString](grpc.queue.queuesendresponse-1.md#tostring)
- [addToRepeatedField](grpc.queue.queuesendresponse-1.md#addtorepeatedfield)
- [addToRepeatedWrapperField](grpc.queue.queuesendresponse-1.md#addtorepeatedwrapperfield)
- [bytesAsB64](grpc.queue.queuesendresponse-1.md#bytesasb64)
- [bytesAsU8](grpc.queue.queuesendresponse-1.md#bytesasu8)
- [bytesListAsB64](grpc.queue.queuesendresponse-1.md#byteslistasb64)
- [bytesListAsU8](grpc.queue.queuesendresponse-1.md#byteslistasu8)
- [clone](grpc.queue.queuesendresponse-1.md#clone)
- [cloneMessage](grpc.queue.queuesendresponse-1.md#clonemessage)
- [compareExtensions](grpc.queue.queuesendresponse-1.md#compareextensions)
- [compareFields](grpc.queue.queuesendresponse-1.md#comparefields)
- [computeOneofCase](grpc.queue.queuesendresponse-1.md#computeoneofcase)
- [copyInto](grpc.queue.queuesendresponse-1.md#copyinto)
- [deserializeBinary](grpc.queue.queuesendresponse-1.md#deserializebinary)
- [deserializeBinaryFromReader](grpc.queue.queuesendresponse-1.md#deserializebinaryfromreader)
- [difference](grpc.queue.queuesendresponse-1.md#difference)
- [equals](grpc.queue.queuesendresponse-1.md#equals)
- [getField](grpc.queue.queuesendresponse-1.md#getfield)
- [getFieldWithDefault](grpc.queue.queuesendresponse-1.md#getfieldwithdefault)
- [getMapField](grpc.queue.queuesendresponse-1.md#getmapfield)
- [getOptionalFloatingPointField](grpc.queue.queuesendresponse-1.md#getoptionalfloatingpointfield)
- [getRepeatedFloatingPointField](grpc.queue.queuesendresponse-1.md#getrepeatedfloatingpointfield)
- [getRepeatedWrapperField](grpc.queue.queuesendresponse-1.md#getrepeatedwrapperfield)
- [getWrapperField](grpc.queue.queuesendresponse-1.md#getwrapperfield)
- [initialize](grpc.queue.queuesendresponse-1.md#initialize)
- [registerMessageType](grpc.queue.queuesendresponse-1.md#registermessagetype)
- [serializeBinaryToWriter](grpc.queue.queuesendresponse-1.md#serializebinarytowriter)
- [setField](grpc.queue.queuesendresponse-1.md#setfield)
- [setOneofField](grpc.queue.queuesendresponse-1.md#setoneoffield)
- [setOneofWrapperField](grpc.queue.queuesendresponse-1.md#setoneofwrapperfield)
- [setRepeatedWrapperField](grpc.queue.queuesendresponse-1.md#setrepeatedwrapperfield)
- [setWrapperField](grpc.queue.queuesendresponse-1.md#setwrapperfield)
- [toMap](grpc.queue.queuesendresponse-1.md#tomap)
- [toObject](grpc.queue.queuesendresponse-1.md#toobject)
- [toObjectExtension](grpc.queue.queuesendresponse-1.md#toobjectextension)
- [toObjectList](grpc.queue.queuesendresponse-1.md#toobjectlist)

## Constructors

### constructor

\+ **new QueueSendResponse**(): [*QueueSendResponse*](grpc.queue.queuesendresponse-1.md)

**Returns:** [*QueueSendResponse*](grpc.queue.queuesendresponse-1.md)
...
Defined in: src/interfaces/queue/v1/queue_pb.d.ts:37
...
Defined in: src/interfaces/queue/v1/queue_pb.d.ts:38
...
Defined in: src/interfaces/queue/v1/queue_pb.d.ts:34
...
▸ **toObject**(`includeInstance?`: *boolean*): [*AsObject*](../modules/grpc.queue.queuesendresponse.md#asobject)
...
**Returns:** [*AsObject*](../modules/grpc.queue.queuesendresponse.md#asobject)

Overrides: jspb.Message.toObject

Defined in: src/interfaces/queue/v1/queue_pb.d.ts:35
...
▸ `Static`**deserializeBinary**(`bytes`: *Uint8Array*): [*QueueSendResponse*](grpc.queue.queuesendresponse-1.md)
...
Defined in: src/interfaces/queue/v1/queue_pb.d.ts:40

___

### deserializeBinaryFromReader

▸ `Static`**deserializeBinaryFromReader**(`message`: [*QueueSendResponse*](grpc.queue.queuesendresponse-1.md), `reader`: *BinaryReader*): [*QueueSendResponse*](grpc.queue.queuesendresponse-1.md)

#### Parameters:

Name | Type |
:------ | :------ |
`message` | [*QueueSendResponse*](grpc.queue.queuesendresponse-1.md) |
`reader` | *BinaryReader* |
...
Defined in: src/interfaces/queue/v1/queue_pb.d.ts:41
...
▸ `Static`**serializeBinaryToWriter**(`message`: [*QueueSendResponse*](grpc.queue.queuesendresponse-1.md), `writer`: *BinaryWriter*): *void*
...
Defined in: src/interfaces/queue/v1/queue_pb.d.ts:39
...
▸ `Static`**toObject**(`includeInstance`: *boolean*, `msg`: [*QueueSendResponse*](grpc.queue.queuesendresponse-1.md)): [*AsObject*](../modules/grpc.queue.queuesendresponse.md#asobject)
...
:------ | :------ |
`includeInstance` | *boolean* |
`msg` | [*QueueSendResponse*](grpc.queue.queuesendresponse-1.md) |

**Returns:** [*AsObject*](../modules/grpc.queue.queuesendresponse.md#asobject)

Overrides: jspb.Message.toObject

Defined in: src/interfaces/queue/v1/queue_pb.d.ts:36
