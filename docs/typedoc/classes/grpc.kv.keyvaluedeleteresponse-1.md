[@nitric/sdk](../README.md) / [grpc](../modules/grpc.md) / [kv](../modules/grpc.kv.md) / KeyValueDeleteResponse

# Class: KeyValueDeleteResponse

[grpc](../modules/grpc.md).[kv](../modules/grpc.kv.md).KeyValueDeleteResponse
...
- [constructor](grpc.kv.keyvaluedeleteresponse-1.md#constructor)

### Properties

- [extensions](grpc.kv.keyvaluedeleteresponse-1.md#extensions)
- [extensionsBinary](grpc.kv.keyvaluedeleteresponse-1.md#extensionsbinary)

### Methods

- [clone](grpc.kv.keyvaluedeleteresponse-1.md#clone)
- [cloneMessage](grpc.kv.keyvaluedeleteresponse-1.md#clonemessage)
- [getExtension](grpc.kv.keyvaluedeleteresponse-1.md#getextension)
- [getJsPbMessageId](grpc.kv.keyvaluedeleteresponse-1.md#getjspbmessageid)
- [readBinaryExtension](grpc.kv.keyvaluedeleteresponse-1.md#readbinaryextension)
- [serializeBinary](grpc.kv.keyvaluedeleteresponse-1.md#serializebinary)
- [serializeBinaryExtensions](grpc.kv.keyvaluedeleteresponse-1.md#serializebinaryextensions)
- [setExtension](grpc.kv.keyvaluedeleteresponse-1.md#setextension)
- [toArray](grpc.kv.keyvaluedeleteresponse-1.md#toarray)
- [toObject](grpc.kv.keyvaluedeleteresponse-1.md#toobject)
- [toString](grpc.kv.keyvaluedeleteresponse-1.md#tostring)
- [addToRepeatedField](grpc.kv.keyvaluedeleteresponse-1.md#addtorepeatedfield)
- [addToRepeatedWrapperField](grpc.kv.keyvaluedeleteresponse-1.md#addtorepeatedwrapperfield)
- [bytesAsB64](grpc.kv.keyvaluedeleteresponse-1.md#bytesasb64)
- [bytesAsU8](grpc.kv.keyvaluedeleteresponse-1.md#bytesasu8)
- [bytesListAsB64](grpc.kv.keyvaluedeleteresponse-1.md#byteslistasb64)
- [bytesListAsU8](grpc.kv.keyvaluedeleteresponse-1.md#byteslistasu8)
- [clone](grpc.kv.keyvaluedeleteresponse-1.md#clone)
- [cloneMessage](grpc.kv.keyvaluedeleteresponse-1.md#clonemessage)
- [compareExtensions](grpc.kv.keyvaluedeleteresponse-1.md#compareextensions)
- [compareFields](grpc.kv.keyvaluedeleteresponse-1.md#comparefields)
- [computeOneofCase](grpc.kv.keyvaluedeleteresponse-1.md#computeoneofcase)
- [copyInto](grpc.kv.keyvaluedeleteresponse-1.md#copyinto)
- [deserializeBinary](grpc.kv.keyvaluedeleteresponse-1.md#deserializebinary)
- [deserializeBinaryFromReader](grpc.kv.keyvaluedeleteresponse-1.md#deserializebinaryfromreader)
- [difference](grpc.kv.keyvaluedeleteresponse-1.md#difference)
- [equals](grpc.kv.keyvaluedeleteresponse-1.md#equals)
- [getField](grpc.kv.keyvaluedeleteresponse-1.md#getfield)
- [getFieldWithDefault](grpc.kv.keyvaluedeleteresponse-1.md#getfieldwithdefault)
- [getMapField](grpc.kv.keyvaluedeleteresponse-1.md#getmapfield)
- [getOptionalFloatingPointField](grpc.kv.keyvaluedeleteresponse-1.md#getoptionalfloatingpointfield)
- [getRepeatedFloatingPointField](grpc.kv.keyvaluedeleteresponse-1.md#getrepeatedfloatingpointfield)
- [getRepeatedWrapperField](grpc.kv.keyvaluedeleteresponse-1.md#getrepeatedwrapperfield)
- [getWrapperField](grpc.kv.keyvaluedeleteresponse-1.md#getwrapperfield)
- [initialize](grpc.kv.keyvaluedeleteresponse-1.md#initialize)
- [registerMessageType](grpc.kv.keyvaluedeleteresponse-1.md#registermessagetype)
- [serializeBinaryToWriter](grpc.kv.keyvaluedeleteresponse-1.md#serializebinarytowriter)
- [setField](grpc.kv.keyvaluedeleteresponse-1.md#setfield)
- [setOneofField](grpc.kv.keyvaluedeleteresponse-1.md#setoneoffield)
- [setOneofWrapperField](grpc.kv.keyvaluedeleteresponse-1.md#setoneofwrapperfield)
- [setRepeatedWrapperField](grpc.kv.keyvaluedeleteresponse-1.md#setrepeatedwrapperfield)
- [setWrapperField](grpc.kv.keyvaluedeleteresponse-1.md#setwrapperfield)
- [toMap](grpc.kv.keyvaluedeleteresponse-1.md#tomap)
- [toObject](grpc.kv.keyvaluedeleteresponse-1.md#toobject)
- [toObjectExtension](grpc.kv.keyvaluedeleteresponse-1.md#toobjectextension)
- [toObjectList](grpc.kv.keyvaluedeleteresponse-1.md#toobjectlist)

## Constructors

### constructor

\+ **new KeyValueDeleteResponse**(): [*KeyValueDeleteResponse*](grpc.kv.keyvaluedeleteresponse-1.md)

**Returns:** [*KeyValueDeleteResponse*](grpc.kv.keyvaluedeleteresponse-1.md)
...
Defined in: src/interfaces/kv/v1/kv_pb.d.ts:127
...
Defined in: src/interfaces/kv/v1/kv_pb.d.ts:128
...
Defined in: src/interfaces/kv/v1/kv_pb.d.ts:124
...
▸ **toObject**(`includeInstance?`: *boolean*): [*AsObject*](../modules/grpc.kv.keyvaluedeleteresponse.md#asobject)
...
**Returns:** [*AsObject*](../modules/grpc.kv.keyvaluedeleteresponse.md#asobject)

Overrides: jspb.Message.toObject

Defined in: src/interfaces/kv/v1/kv_pb.d.ts:125
...
▸ `Static`**deserializeBinary**(`bytes`: *Uint8Array*): [*KeyValueDeleteResponse*](grpc.kv.keyvaluedeleteresponse-1.md)
...
Defined in: src/interfaces/kv/v1/kv_pb.d.ts:130

___

### deserializeBinaryFromReader

▸ `Static`**deserializeBinaryFromReader**(`message`: [*KeyValueDeleteResponse*](grpc.kv.keyvaluedeleteresponse-1.md), `reader`: *BinaryReader*): [*KeyValueDeleteResponse*](grpc.kv.keyvaluedeleteresponse-1.md)

#### Parameters:

Name | Type |
:------ | :------ |
`message` | [*KeyValueDeleteResponse*](grpc.kv.keyvaluedeleteresponse-1.md) |
`reader` | *BinaryReader* |
...
Defined in: src/interfaces/kv/v1/kv_pb.d.ts:131
...
▸ `Static`**serializeBinaryToWriter**(`message`: [*KeyValueDeleteResponse*](grpc.kv.keyvaluedeleteresponse-1.md), `writer`: *BinaryWriter*): *void*
...
Defined in: src/interfaces/kv/v1/kv_pb.d.ts:129
...
▸ `Static`**toObject**(`includeInstance`: *boolean*, `msg`: [*KeyValueDeleteResponse*](grpc.kv.keyvaluedeleteresponse-1.md)): [*AsObject*](../modules/grpc.kv.keyvaluedeleteresponse.md#asobject)
...
:------ | :------ |
`includeInstance` | *boolean* |
`msg` | [*KeyValueDeleteResponse*](grpc.kv.keyvaluedeleteresponse-1.md) |

**Returns:** [*AsObject*](../modules/grpc.kv.keyvaluedeleteresponse.md#asobject)

Overrides: jspb.Message.toObject

Defined in: src/interfaces/kv/v1/kv_pb.d.ts:126
