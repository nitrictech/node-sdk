...
Defined in: [src/api/event/event.ts:26](https://github.com/nitrictech/node-sdk/blob/3e510a5/src/api/event/event.ts#L26)
...
Defined in: [src/api/event/event.ts:59](https://github.com/nitrictech/node-sdk/blob/3e510a5/src/api/event/event.ts#L59)
