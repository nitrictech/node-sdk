...
Defined in: [src/api/event/event.ts:13](https://github.com/nitrictech/node-sdk/blob/6836675/src/api/event/event.ts#L13)
...
Defined in: [src/api/event/event.ts:46](https://github.com/nitrictech/node-sdk/blob/6836675/src/api/event/event.ts#L46)
