[@nitric/sdk](../README.md) / [grpc](../modules/grpc.md) / [event](../modules/grpc.event.md) / TopicListRequest

# Class: TopicListRequest

[grpc](../modules/grpc.md).[event](../modules/grpc.event.md).TopicListRequest
...
- [constructor](grpc.event.topiclistrequest-1.md#constructor)

### Properties

- [extensions](grpc.event.topiclistrequest-1.md#extensions)
- [extensionsBinary](grpc.event.topiclistrequest-1.md#extensionsbinary)

### Methods

- [clone](grpc.event.topiclistrequest-1.md#clone)
- [cloneMessage](grpc.event.topiclistrequest-1.md#clonemessage)
- [getExtension](grpc.event.topiclistrequest-1.md#getextension)
- [getJsPbMessageId](grpc.event.topiclistrequest-1.md#getjspbmessageid)
- [readBinaryExtension](grpc.event.topiclistrequest-1.md#readbinaryextension)
- [serializeBinary](grpc.event.topiclistrequest-1.md#serializebinary)
- [serializeBinaryExtensions](grpc.event.topiclistrequest-1.md#serializebinaryextensions)
- [setExtension](grpc.event.topiclistrequest-1.md#setextension)
- [toArray](grpc.event.topiclistrequest-1.md#toarray)
- [toObject](grpc.event.topiclistrequest-1.md#toobject)
- [toString](grpc.event.topiclistrequest-1.md#tostring)
- [addToRepeatedField](grpc.event.topiclistrequest-1.md#addtorepeatedfield)
- [addToRepeatedWrapperField](grpc.event.topiclistrequest-1.md#addtorepeatedwrapperfield)
- [bytesAsB64](grpc.event.topiclistrequest-1.md#bytesasb64)
- [bytesAsU8](grpc.event.topiclistrequest-1.md#bytesasu8)
- [bytesListAsB64](grpc.event.topiclistrequest-1.md#byteslistasb64)
- [bytesListAsU8](grpc.event.topiclistrequest-1.md#byteslistasu8)
- [clone](grpc.event.topiclistrequest-1.md#clone)
- [cloneMessage](grpc.event.topiclistrequest-1.md#clonemessage)
- [compareExtensions](grpc.event.topiclistrequest-1.md#compareextensions)
- [compareFields](grpc.event.topiclistrequest-1.md#comparefields)
- [computeOneofCase](grpc.event.topiclistrequest-1.md#computeoneofcase)
- [copyInto](grpc.event.topiclistrequest-1.md#copyinto)
- [deserializeBinary](grpc.event.topiclistrequest-1.md#deserializebinary)
- [deserializeBinaryFromReader](grpc.event.topiclistrequest-1.md#deserializebinaryfromreader)
- [difference](grpc.event.topiclistrequest-1.md#difference)
- [equals](grpc.event.topiclistrequest-1.md#equals)
- [getField](grpc.event.topiclistrequest-1.md#getfield)
- [getFieldWithDefault](grpc.event.topiclistrequest-1.md#getfieldwithdefault)
- [getMapField](grpc.event.topiclistrequest-1.md#getmapfield)
- [getOptionalFloatingPointField](grpc.event.topiclistrequest-1.md#getoptionalfloatingpointfield)
- [getRepeatedFloatingPointField](grpc.event.topiclistrequest-1.md#getrepeatedfloatingpointfield)
- [getRepeatedWrapperField](grpc.event.topiclistrequest-1.md#getrepeatedwrapperfield)
- [getWrapperField](grpc.event.topiclistrequest-1.md#getwrapperfield)
- [initialize](grpc.event.topiclistrequest-1.md#initialize)
- [registerMessageType](grpc.event.topiclistrequest-1.md#registermessagetype)
- [serializeBinaryToWriter](grpc.event.topiclistrequest-1.md#serializebinarytowriter)
- [setField](grpc.event.topiclistrequest-1.md#setfield)
- [setOneofField](grpc.event.topiclistrequest-1.md#setoneoffield)
- [setOneofWrapperField](grpc.event.topiclistrequest-1.md#setoneofwrapperfield)
- [setRepeatedWrapperField](grpc.event.topiclistrequest-1.md#setrepeatedwrapperfield)
- [setWrapperField](grpc.event.topiclistrequest-1.md#setwrapperfield)
- [toMap](grpc.event.topiclistrequest-1.md#tomap)
- [toObject](grpc.event.topiclistrequest-1.md#toobject)
- [toObjectExtension](grpc.event.topiclistrequest-1.md#toobjectextension)
- [toObjectList](grpc.event.topiclistrequest-1.md#toobjectlist)

## Constructors

### constructor

\+ **new TopicListRequest**(): [*TopicListRequest*](grpc.event.topiclistrequest-1.md)

**Returns:** [*TopicListRequest*](grpc.event.topiclistrequest-1.md)
...
Defined in: src/interfaces/event/v1/event_pb.d.ts:57
...
Defined in: src/interfaces/event/v1/event_pb.d.ts:58
...
Defined in: src/interfaces/event/v1/event_pb.d.ts:54
...
▸ **toObject**(`includeInstance?`: *boolean*): [*AsObject*](../modules/grpc.event.topiclistrequest.md#asobject)
...
**Returns:** [*AsObject*](../modules/grpc.event.topiclistrequest.md#asobject)

Overrides: jspb.Message.toObject

Defined in: src/interfaces/event/v1/event_pb.d.ts:55
...
▸ `Static`**deserializeBinary**(`bytes`: *Uint8Array*): [*TopicListRequest*](grpc.event.topiclistrequest-1.md)
...
Defined in: src/interfaces/event/v1/event_pb.d.ts:60

___

### deserializeBinaryFromReader

▸ `Static`**deserializeBinaryFromReader**(`message`: [*TopicListRequest*](grpc.event.topiclistrequest-1.md), `reader`: *BinaryReader*): [*TopicListRequest*](grpc.event.topiclistrequest-1.md)

#### Parameters:

Name | Type |
:------ | :------ |
`message` | [*TopicListRequest*](grpc.event.topiclistrequest-1.md) |
`reader` | *BinaryReader* |
...
Defined in: src/interfaces/event/v1/event_pb.d.ts:61
...
▸ `Static`**serializeBinaryToWriter**(`message`: [*TopicListRequest*](grpc.event.topiclistrequest-1.md), `writer`: *BinaryWriter*): *void*
...
Defined in: src/interfaces/event/v1/event_pb.d.ts:59
...
▸ `Static`**toObject**(`includeInstance`: *boolean*, `msg`: [*TopicListRequest*](grpc.event.topiclistrequest-1.md)): [*AsObject*](../modules/grpc.event.topiclistrequest.md#asobject)
...
:------ | :------ |
`includeInstance` | *boolean* |
`msg` | [*TopicListRequest*](grpc.event.topiclistrequest-1.md) |

**Returns:** [*AsObject*](../modules/grpc.event.topiclistrequest.md#asobject)

Overrides: jspb.Message.toObject

Defined in: src/interfaces/event/v1/event_pb.d.ts:56
