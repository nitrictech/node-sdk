[@nitric/sdk](../README.md) / [grpc](../modules/grpc.md) / [kv](../modules/grpc.kv.md) / KeyValueGetRequest

# Class: KeyValueGetRequest

[grpc](../modules/grpc.md).[kv](../modules/grpc.kv.md).KeyValueGetRequest
...
- [constructor](grpc.kv.keyvaluegetrequest-1.md#constructor)

### Properties

- [extensions](grpc.kv.keyvaluegetrequest-1.md#extensions)
- [extensionsBinary](grpc.kv.keyvaluegetrequest-1.md#extensionsbinary)

### Methods

- [clone](grpc.kv.keyvaluegetrequest-1.md#clone)
- [cloneMessage](grpc.kv.keyvaluegetrequest-1.md#clonemessage)
- [getCollection](grpc.kv.keyvaluegetrequest-1.md#getcollection)
- [getExtension](grpc.kv.keyvaluegetrequest-1.md#getextension)
- [getJsPbMessageId](grpc.kv.keyvaluegetrequest-1.md#getjspbmessageid)
- [getKey](grpc.kv.keyvaluegetrequest-1.md#getkey)
- [readBinaryExtension](grpc.kv.keyvaluegetrequest-1.md#readbinaryextension)
- [serializeBinary](grpc.kv.keyvaluegetrequest-1.md#serializebinary)
- [serializeBinaryExtensions](grpc.kv.keyvaluegetrequest-1.md#serializebinaryextensions)
- [setCollection](grpc.kv.keyvaluegetrequest-1.md#setcollection)
- [setExtension](grpc.kv.keyvaluegetrequest-1.md#setextension)
- [setKey](grpc.kv.keyvaluegetrequest-1.md#setkey)
- [toArray](grpc.kv.keyvaluegetrequest-1.md#toarray)
- [toObject](grpc.kv.keyvaluegetrequest-1.md#toobject)
- [toString](grpc.kv.keyvaluegetrequest-1.md#tostring)
- [addToRepeatedField](grpc.kv.keyvaluegetrequest-1.md#addtorepeatedfield)
- [addToRepeatedWrapperField](grpc.kv.keyvaluegetrequest-1.md#addtorepeatedwrapperfield)
- [bytesAsB64](grpc.kv.keyvaluegetrequest-1.md#bytesasb64)
- [bytesAsU8](grpc.kv.keyvaluegetrequest-1.md#bytesasu8)
- [bytesListAsB64](grpc.kv.keyvaluegetrequest-1.md#byteslistasb64)
- [bytesListAsU8](grpc.kv.keyvaluegetrequest-1.md#byteslistasu8)
- [clone](grpc.kv.keyvaluegetrequest-1.md#clone)
- [cloneMessage](grpc.kv.keyvaluegetrequest-1.md#clonemessage)
- [compareExtensions](grpc.kv.keyvaluegetrequest-1.md#compareextensions)
- [compareFields](grpc.kv.keyvaluegetrequest-1.md#comparefields)
- [computeOneofCase](grpc.kv.keyvaluegetrequest-1.md#computeoneofcase)
- [copyInto](grpc.kv.keyvaluegetrequest-1.md#copyinto)
- [deserializeBinary](grpc.kv.keyvaluegetrequest-1.md#deserializebinary)
- [deserializeBinaryFromReader](grpc.kv.keyvaluegetrequest-1.md#deserializebinaryfromreader)
- [difference](grpc.kv.keyvaluegetrequest-1.md#difference)
- [equals](grpc.kv.keyvaluegetrequest-1.md#equals)
- [getField](grpc.kv.keyvaluegetrequest-1.md#getfield)
- [getFieldWithDefault](grpc.kv.keyvaluegetrequest-1.md#getfieldwithdefault)
- [getMapField](grpc.kv.keyvaluegetrequest-1.md#getmapfield)
- [getOptionalFloatingPointField](grpc.kv.keyvaluegetrequest-1.md#getoptionalfloatingpointfield)
- [getRepeatedFloatingPointField](grpc.kv.keyvaluegetrequest-1.md#getrepeatedfloatingpointfield)
- [getRepeatedWrapperField](grpc.kv.keyvaluegetrequest-1.md#getrepeatedwrapperfield)
- [getWrapperField](grpc.kv.keyvaluegetrequest-1.md#getwrapperfield)
- [initialize](grpc.kv.keyvaluegetrequest-1.md#initialize)
- [registerMessageType](grpc.kv.keyvaluegetrequest-1.md#registermessagetype)
- [serializeBinaryToWriter](grpc.kv.keyvaluegetrequest-1.md#serializebinarytowriter)
- [setField](grpc.kv.keyvaluegetrequest-1.md#setfield)
- [setOneofField](grpc.kv.keyvaluegetrequest-1.md#setoneoffield)
- [setOneofWrapperField](grpc.kv.keyvaluegetrequest-1.md#setoneofwrapperfield)
- [setRepeatedWrapperField](grpc.kv.keyvaluegetrequest-1.md#setrepeatedwrapperfield)
- [setWrapperField](grpc.kv.keyvaluegetrequest-1.md#setwrapperfield)
- [toMap](grpc.kv.keyvaluegetrequest-1.md#tomap)
- [toObject](grpc.kv.keyvaluegetrequest-1.md#toobject)
- [toObjectExtension](grpc.kv.keyvaluegetrequest-1.md#toobjectextension)
- [toObjectList](grpc.kv.keyvaluegetrequest-1.md#toobjectlist)

## Constructors

### constructor

\+ **new KeyValueGetRequest**(): [*KeyValueGetRequest*](grpc.kv.keyvaluegetrequest-1.md)

**Returns:** [*KeyValueGetRequest*](grpc.kv.keyvaluegetrequest-1.md)
...
Defined in: src/interfaces/kv/v1/kv_pb.d.ts:17
...
Defined in: src/interfaces/kv/v1/kv_pb.d.ts:18
...
Defined in: src/interfaces/kv/v1/kv_pb.d.ts:8
...
Defined in: src/interfaces/kv/v1/kv_pb.d.ts:11
...
Defined in: src/interfaces/kv/v1/kv_pb.d.ts:14
...
Defined in: src/interfaces/kv/v1/kv_pb.d.ts:9
...
Defined in: src/interfaces/kv/v1/kv_pb.d.ts:12
...
▸ **toObject**(`includeInstance?`: *boolean*): [*AsObject*](../modules/grpc.kv.keyvaluegetrequest.md#asobject)
...
**Returns:** [*AsObject*](../modules/grpc.kv.keyvaluegetrequest.md#asobject)

Overrides: jspb.Message.toObject

Defined in: src/interfaces/kv/v1/kv_pb.d.ts:15
...
▸ `Static`**deserializeBinary**(`bytes`: *Uint8Array*): [*KeyValueGetRequest*](grpc.kv.keyvaluegetrequest-1.md)
...
Defined in: src/interfaces/kv/v1/kv_pb.d.ts:20

___

### deserializeBinaryFromReader

▸ `Static`**deserializeBinaryFromReader**(`message`: [*KeyValueGetRequest*](grpc.kv.keyvaluegetrequest-1.md), `reader`: *BinaryReader*): [*KeyValueGetRequest*](grpc.kv.keyvaluegetrequest-1.md)

#### Parameters:

Name | Type |
:------ | :------ |
`message` | [*KeyValueGetRequest*](grpc.kv.keyvaluegetrequest-1.md) |
`reader` | *BinaryReader* |
...
Defined in: src/interfaces/kv/v1/kv_pb.d.ts:21
...
▸ `Static`**serializeBinaryToWriter**(`message`: [*KeyValueGetRequest*](grpc.kv.keyvaluegetrequest-1.md), `writer`: *BinaryWriter*): *void*
...
Defined in: src/interfaces/kv/v1/kv_pb.d.ts:19
...
▸ `Static`**toObject**(`includeInstance`: *boolean*, `msg`: [*KeyValueGetRequest*](grpc.kv.keyvaluegetrequest-1.md)): [*AsObject*](../modules/grpc.kv.keyvaluegetrequest.md#asobject)
...
:------ | :------ |
`includeInstance` | *boolean* |
`msg` | [*KeyValueGetRequest*](grpc.kv.keyvaluegetrequest-1.md) |

**Returns:** [*AsObject*](../modules/grpc.kv.keyvaluegetrequest.md#asobject)

Overrides: jspb.Message.toObject

Defined in: src/interfaces/kv/v1/kv_pb.d.ts:16
