[@nitric/sdk](../README.md) / [grpc](../modules/grpc.md) / [kv](../modules/grpc.kv.md) / KeyValuePutResponse

# Class: KeyValuePutResponse

[grpc](../modules/grpc.md).[kv](../modules/grpc.kv.md).KeyValuePutResponse
...
- [constructor](grpc.kv.keyvalueputresponse-1.md#constructor)

### Properties

- [extensions](grpc.kv.keyvalueputresponse-1.md#extensions)
- [extensionsBinary](grpc.kv.keyvalueputresponse-1.md#extensionsbinary)

### Methods

- [clone](grpc.kv.keyvalueputresponse-1.md#clone)
- [cloneMessage](grpc.kv.keyvalueputresponse-1.md#clonemessage)
- [getExtension](grpc.kv.keyvalueputresponse-1.md#getextension)
- [getJsPbMessageId](grpc.kv.keyvalueputresponse-1.md#getjspbmessageid)
- [readBinaryExtension](grpc.kv.keyvalueputresponse-1.md#readbinaryextension)
- [serializeBinary](grpc.kv.keyvalueputresponse-1.md#serializebinary)
- [serializeBinaryExtensions](grpc.kv.keyvalueputresponse-1.md#serializebinaryextensions)
- [setExtension](grpc.kv.keyvalueputresponse-1.md#setextension)
- [toArray](grpc.kv.keyvalueputresponse-1.md#toarray)
- [toObject](grpc.kv.keyvalueputresponse-1.md#toobject)
- [toString](grpc.kv.keyvalueputresponse-1.md#tostring)
- [addToRepeatedField](grpc.kv.keyvalueputresponse-1.md#addtorepeatedfield)
- [addToRepeatedWrapperField](grpc.kv.keyvalueputresponse-1.md#addtorepeatedwrapperfield)
- [bytesAsB64](grpc.kv.keyvalueputresponse-1.md#bytesasb64)
- [bytesAsU8](grpc.kv.keyvalueputresponse-1.md#bytesasu8)
- [bytesListAsB64](grpc.kv.keyvalueputresponse-1.md#byteslistasb64)
- [bytesListAsU8](grpc.kv.keyvalueputresponse-1.md#byteslistasu8)
- [clone](grpc.kv.keyvalueputresponse-1.md#clone)
- [cloneMessage](grpc.kv.keyvalueputresponse-1.md#clonemessage)
- [compareExtensions](grpc.kv.keyvalueputresponse-1.md#compareextensions)
- [compareFields](grpc.kv.keyvalueputresponse-1.md#comparefields)
- [computeOneofCase](grpc.kv.keyvalueputresponse-1.md#computeoneofcase)
- [copyInto](grpc.kv.keyvalueputresponse-1.md#copyinto)
- [deserializeBinary](grpc.kv.keyvalueputresponse-1.md#deserializebinary)
- [deserializeBinaryFromReader](grpc.kv.keyvalueputresponse-1.md#deserializebinaryfromreader)
- [difference](grpc.kv.keyvalueputresponse-1.md#difference)
- [equals](grpc.kv.keyvalueputresponse-1.md#equals)
- [getField](grpc.kv.keyvalueputresponse-1.md#getfield)
- [getFieldWithDefault](grpc.kv.keyvalueputresponse-1.md#getfieldwithdefault)
- [getMapField](grpc.kv.keyvalueputresponse-1.md#getmapfield)
- [getOptionalFloatingPointField](grpc.kv.keyvalueputresponse-1.md#getoptionalfloatingpointfield)
- [getRepeatedFloatingPointField](grpc.kv.keyvalueputresponse-1.md#getrepeatedfloatingpointfield)
- [getRepeatedWrapperField](grpc.kv.keyvalueputresponse-1.md#getrepeatedwrapperfield)
- [getWrapperField](grpc.kv.keyvalueputresponse-1.md#getwrapperfield)
- [initialize](grpc.kv.keyvalueputresponse-1.md#initialize)
- [registerMessageType](grpc.kv.keyvalueputresponse-1.md#registermessagetype)
- [serializeBinaryToWriter](grpc.kv.keyvalueputresponse-1.md#serializebinarytowriter)
- [setField](grpc.kv.keyvalueputresponse-1.md#setfield)
- [setOneofField](grpc.kv.keyvalueputresponse-1.md#setoneoffield)
- [setOneofWrapperField](grpc.kv.keyvalueputresponse-1.md#setoneofwrapperfield)
- [setRepeatedWrapperField](grpc.kv.keyvalueputresponse-1.md#setrepeatedwrapperfield)
- [setWrapperField](grpc.kv.keyvalueputresponse-1.md#setwrapperfield)
- [toMap](grpc.kv.keyvalueputresponse-1.md#tomap)
- [toObject](grpc.kv.keyvalueputresponse-1.md#toobject)
- [toObjectExtension](grpc.kv.keyvalueputresponse-1.md#toobjectextension)
- [toObjectList](grpc.kv.keyvalueputresponse-1.md#toobjectlist)

## Constructors

### constructor

\+ **new KeyValuePutResponse**(): [*KeyValuePutResponse*](grpc.kv.keyvalueputresponse-1.md)

**Returns:** [*KeyValuePutResponse*](grpc.kv.keyvalueputresponse-1.md)
...
Defined in: src/interfaces/kv/v1/kv_pb.d.ts:87
...
Defined in: src/interfaces/kv/v1/kv_pb.d.ts:88
...
Defined in: src/interfaces/kv/v1/kv_pb.d.ts:84
...
▸ **toObject**(`includeInstance?`: *boolean*): [*AsObject*](../modules/grpc.kv.keyvalueputresponse.md#asobject)
...
**Returns:** [*AsObject*](../modules/grpc.kv.keyvalueputresponse.md#asobject)

Overrides: jspb.Message.toObject

Defined in: src/interfaces/kv/v1/kv_pb.d.ts:85
...
▸ `Static`**deserializeBinary**(`bytes`: *Uint8Array*): [*KeyValuePutResponse*](grpc.kv.keyvalueputresponse-1.md)
...
Defined in: src/interfaces/kv/v1/kv_pb.d.ts:90

___

### deserializeBinaryFromReader

▸ `Static`**deserializeBinaryFromReader**(`message`: [*KeyValuePutResponse*](grpc.kv.keyvalueputresponse-1.md), `reader`: *BinaryReader*): [*KeyValuePutResponse*](grpc.kv.keyvalueputresponse-1.md)

#### Parameters:

Name | Type |
:------ | :------ |
`message` | [*KeyValuePutResponse*](grpc.kv.keyvalueputresponse-1.md) |
`reader` | *BinaryReader* |
...
Defined in: src/interfaces/kv/v1/kv_pb.d.ts:91
...
▸ `Static`**serializeBinaryToWriter**(`message`: [*KeyValuePutResponse*](grpc.kv.keyvalueputresponse-1.md), `writer`: *BinaryWriter*): *void*
...
Defined in: src/interfaces/kv/v1/kv_pb.d.ts:89
...
▸ `Static`**toObject**(`includeInstance`: *boolean*, `msg`: [*KeyValuePutResponse*](grpc.kv.keyvalueputresponse-1.md)): [*AsObject*](../modules/grpc.kv.keyvalueputresponse.md#asobject)
...
:------ | :------ |
`includeInstance` | *boolean* |
`msg` | [*KeyValuePutResponse*](grpc.kv.keyvalueputresponse-1.md) |

**Returns:** [*AsObject*](../modules/grpc.kv.keyvalueputresponse.md#asobject)

Overrides: jspb.Message.toObject

Defined in: src/interfaces/kv/v1/kv_pb.d.ts:86
