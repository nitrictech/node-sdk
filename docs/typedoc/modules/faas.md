...
Defined in: [src/faas/function.ts:27](https://github.com/nitrictech/node-sdk/blob/b8bfc08/src/faas/function.ts#L27)
...
Defined in: [src/faas/start.ts:48](https://github.com/nitrictech/node-sdk/blob/b8bfc08/src/faas/start.ts#L48)
