...
Defined in: [src/faas/function.ts:27](https://github.com/nitrictech/node-sdk/blob/b9cc8cf/src/faas/function.ts#L27)
...
Defined in: [src/faas/start.ts:48](https://github.com/nitrictech/node-sdk/blob/b9cc8cf/src/faas/start.ts#L48)
