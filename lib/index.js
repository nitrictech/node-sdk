...
var require_keyvalue_grpc_pb = __commonJS({
  "src/gen/nitric/proto/keyvalue/v1/keyvalue_grpc_pb.js"(exports) {
    ...
    exports.KeyValueClient = grpc14.makeGenericClientConstructor(KeyValueService);
  }
});
...
var TopicResource = class extends SecureResource {
  ...
  register() {
    return __async(this, null, function* () {
      ...
      req.setId(resource);
      req.setTopic(new import_resources_pb3.TopicResource());
      return new Promise((resolve, reject) => {
    ...
    return perms.reduce((actions, p) => {
      switch (p) {
        case "publishing":
          return [
            ...actions,
            import_resources_pb3.Action.TOPICPUBLISH
          ];
        default:
          throw new Error(
...
var QueueResource = class extends SecureResource {
  ...
  register() {
    return __async(this, null, function* () {
      ...
      resource.setName(this.name);
      resource.setType(import_resources_pb4.ResourceType.QUEUE);
      req.setId(resource);
      req.setQueue(new import_resources_pb4.QueueResource());
      return new Promise((resolve, reject) => {
        client_default.declare(req, (error) => {
          if (error) {
            reject(fromGrpcError(error));
  ...
  permsToActions(...perms) {
    let actions = perms.reduce((actions2, p) => {
      switch (p) {
        case "enqueue":
          return [...actions2, import_resources_pb4.Action.QUEUEENQUEUE];
        case "dequeue":
          return [...actions2, import_resources_pb4.Action.QUEUEDEQUEUE];
        default:
          throw new Error(
            `unknown permission ${p}, supported permissions is publishing.}
            )}`
  ...
  resourceType() {
    return import_resources_pb4.ResourceType.QUEUE;
  }
  unwrapDetails(resp) {
...
var KeyValueStoreResource = class extends SecureResource {
  ...
  register() {
    return __async(this, null, function* () {
      ...
      resource.setName(this.name);
      resource.setType(import_resources_pb5.ResourceType.KEYVALUESTORE);
      req.setId(resource);
      req.setKeyValueStore(new import_resources_pb5.KeyValueStoreResource());
      return new Promise((resolve, reject) => {
        client_default.declare(
          req,
          (error, _response) => {
  ...
  permsToActions(...perms) {
    const actions = perms.reduce((actions2, perm) => {
      switch (perm) {
        case "getting":
          return [...actions2, import_resources_pb5.Action.KEYVALUESTOREREAD];
        case "setting":
          return [...actions2, import_resources_pb5.Action.KEYVALUESTOREWRITE];
        case "deleting":
          return [...actions2, import_resources_pb5.Action.KEYVALUESTOREDELETE];
        default:
          throw new Error(
  ...
  resourceType() {
    return import_resources_pb5.ResourceType.KEYVALUESTORE;
  }
  /**
...
var BucketResource = class extends SecureResource {
  ...
  register() {
    return __async(this, null, function* () {
      ...
      resource.setName(this.name);
      resource.setType(import_resources_pb6.ResourceType.BUCKET);
      req.setId(resource);
      req.setBucket(new import_resources_pb6.BucketResource());
      return new Promise((resolve, reject) => {
        client_default.declare(req, (error, _) => {
          if (error) {
            reject(fromGrpcError(error));
  ...
  permsToActions(...perms) {
    return perms.reduce((actions, perm) => {
      switch (perm) {
        case "reading":
          return [...actions, import_resources_pb6.Action.BUCKETFILEGET, import_resources_pb6.Action.BUCKETFILELIST];
        case "writing":
          return [...actions, import_resources_pb6.Action.BUCKETFILEPUT];
        case "deleting":
          return [...actions, import_resources_pb6.Action.BUCKETFILEDELETE];
        default:
          throw new Error(
  ...
  resourceType() {
    return import_resources_pb6.ResourceType.BUCKET;
  }
  /**
...
var SecretResource = class extends SecureResource {
  register() {
    return __async(this, null, function* () {
      ...
      resource.setName(this.name);
      resource.setType(import_resources_pb7.ResourceType.SECRET);
      req.setSecret(new import_resources_pb7.SecretResource());
      req.setId(resource);
      return new Promise((resolve, reject) => {
        client_default.declare(
          req,
  ...
  permsToActions(...perms) {
    return perms.reduce((actions, perm) => {
      switch (perm) {
        case "putting":
          return [...actions, import_resources_pb7.Action.SECRETPUT];
        case "accessing":
          return [...actions, import_resources_pb7.Action.SECRETACCESS];
        default:
          throw new Error(
  ...
  resourceType() {
    return import_resources_pb7.ResourceType.SECRET;
  }
  for(perm, ...perms) {
    this.registerPolicy(perm, ...perms);
...
var WebsocketResource = class extends Resource {
  ...
  register() {
    return __async(this, null, function* () {
      ...
      resource.setName(this.name);
      resource.setType(import_resources_pb8.ResourceType.WEBSOCKET);
      req.setId(resource);
      ...
      const defaultPrincipal = new import_resources_pb8.ResourceIdentifier();
      defaultPrincipal.setType(import_resources_pb8.ResourceType.SERVICE);
      const policyResource = new import_resources_pb8.ResourceIdentifier();
      policyResource.setType(import_resources_pb8.ResourceType.POLICY);
      const policyReq = new import_resources_pb8.ResourceDeclareRequest();
      const policy = new import_resources_pb8.PolicyResource();
      policy.setActionsList([import_resources_pb8.Action.WEBSOCKETMANAGE]);
      policy.setPrincipalsList([defaultPrincipal]);
      policy.setResourcesList([resource]);
  ...
  resourceType() {
    return import_resources_pb8.ResourceType.WEBSOCKET;
  }
};
