...
var oidcRule = ({ name, issuer, audiences }) => {
  return (...scopes) => {
    return {
      name,
      issuer,
    ...
    return perms.reduce((actions, p) => {
      switch (p) {
        case "publishing":
          return [
            ...actions,
            import_resources_pb4.Action.TOPICPUBLISH
          ];
        default:
          throw new Error(
...
var everything2 = ["getting", "setting", "deleting"];
...
// src/resources/bucket.ts
var everything3 = ["reading", "writing", "deleting"];
...
// src/resources/secret.ts
var everything4 = ["putting", "accessing"];
