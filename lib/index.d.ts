...
declare class Topic {
     ...
     * ```
     */
    publish(event: NitricEvent, opts?: PublishOptions): Promise<NitricEvent>;
}
/**
...
declare abstract class TriggerContext<Req extends AbstractRequest = AbstractRequest, Resp extends Record<string, any> = any> {
     ...
     * @returns undefined
     */
    get notification(): BucketNotificationContext | undefined;
    /**
...
declare abstract class AbstractRequest {
...
declare class EventContext extends TriggerContext<EventRequest, EventResponse> {
...
declare class BucketNotificationContext extends TriggerContext<BucketNotificationRequest, BucketNotificationResponse> {
    get notification(): BucketNotificationContext;
    static fromGrpcTriggerRequest(trigger: TriggerRequest): BucketNotificationContext;
...
declare class BucketNotificationRequest extends AbstractRequest {
    ...
    constructor(data: string | Uint8Array, traceContext: api$1.Context, attributes: Record<string, string>);
...
type EventHandler = GenericHandler<EventContext>;
...
type EventMiddleware = GenericMiddleware<EventContext>;
 ...
 */
declare const createHandler: <Ctx extends TriggerContext<AbstractRequest, any> = TriggerContext<AbstractRequest, any>>(...handlers: GenericMiddleware<Ctx>[]) => GenericMiddleware<Ctx>;
...
declare class Route<SecurityDefs extends string> {
     ...
     */
    get(middleware: HttpMiddleware | HttpMiddleware[], opts?: MethodOptions<SecurityDefs>): Promise<void>;
    /**
     ...
     * @returns a Promise that resolves if the handler stops running
     */
    post(middleware: HttpMiddleware | HttpMiddleware[], opts?: MethodOptions<SecurityDefs>): Promise<void>;
    /**
     ...
     * @returns a Promise that resolves if the handler stops running
     */
    put(middleware: HttpMiddleware | HttpMiddleware[], opts?: MethodOptions<SecurityDefs>): Promise<void>;
    /**
     ...
     * @returns a Promise that resolves if the handler stops running
     */
    patch(middleware: HttpMiddleware | HttpMiddleware[], opts?: MethodOptions<SecurityDefs>): Promise<void>;
    /**
     ...
     * @returns a Promise that resolves if the handler stops running
     */
    delete(middleware: HttpMiddleware | HttpMiddleware[], opts?: MethodOptions<SecurityDefs>): Promise<void>;
    /**
     ...
     * @returns a Promise that resolves if the handler stops running
     */
    options(middleware: HttpMiddleware | HttpMiddleware[], opts?: MethodOptions<SecurityDefs>): Promise<void>;
    /**
     ...
     * @returns a Promise that resolves if the handler stops running
     */
    all(middleware: HttpMiddleware | HttpMiddleware[], opts?: MethodOptions<SecurityDefs>): Promise<void>;
}
...
declare class Api<SecurityDefs extends string> extends Resource<ApiDetails> {
     ...
     */
    get(match: string, middleware: HttpMiddleware | HttpMiddleware[], opts?: MethodOptions<SecurityDefs>): Promise<void>;
    /**
     ...
     * @returns A Promise that resolves when the handler terminates.
     */
    post(match: string, middleware: HttpMiddleware | HttpMiddleware[], opts?: MethodOptions<SecurityDefs>): Promise<void>;
    /**
     ...
     * @returns A Promise that resolves when the handler terminates.
     */
    put(match: string, middleware: HttpMiddleware | HttpMiddleware[], opts?: MethodOptions<SecurityDefs>): Promise<void>;
    /**
     ...
     * @returns A Promise that resolves when the handler terminates.
     */
    patch(match: string, middleware: HttpMiddleware | HttpMiddleware[], opts?: MethodOptions<SecurityDefs>): Promise<void>;
    /**
     ...
     * @returns A Promise that resolves when the handler terminates.
     */
    delete(match: string, middleware: HttpMiddleware | HttpMiddleware[], opts?: MethodOptions<SecurityDefs>): Promise<void>;
    /**
     ...
     * @returns A Promise that resolves when the handler terminates.
     */
    options(match: string, middleware: HttpMiddleware | HttpMiddleware[], opts?: MethodOptions<SecurityDefs>): Promise<void>;
    /**
 ...
 */
declare const api: <Defs extends string>(name: string, options?: ApiOpts<Defs>) => Api<Defs>;
/**
 ...
 */
declare const jwt: (opts: Omit<JwtSecurityDefinition, 'kind'>) => JwtSecurityDefinition;
 ...
 */
declare class TopicResource extends SecureResource<TopicPermission> {
    /**
...
declare const topic: newer<TopicResource>;

type QueuePermission = 'sending' | 'receiving';
/**
 * Queue resource for async send/receive messaging
 */
declare class QueueResource extends SecureResource<QueuePermission> {
    /**
...
declare const queue: newer<QueueResource>;
...
type FaasClientOptions = ApiWorkerOptions | RateWorkerOptions | CronWorkerOptions | FaasWorkerOptions | BucketNotificationWorkerOptions;
/**
 *
 */
declare class Faas {
...
type index_AbstractRequest = AbstractRequest;
