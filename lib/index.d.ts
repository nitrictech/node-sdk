...
declare class JobDefinitionResource extends Resource {
    constructor(name: string);
    protected register(): Promise<ResourceIdentifier>;
 ...
 * @returns a SQL resource
 */
declare const jobDefinition: newer<JobDefinitionResource>;
